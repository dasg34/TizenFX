...
/// 
/// The container will slide in the content sideways, the old content will slide out.</summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.UI.Pager.NativeMethods]
[CoreUI.Wrapper.BindingEntity]
[SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
public class Pager : CoreUI.UI.Spotlight.Container
{
...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    public Pager(CoreUI.Object parent, System.String style = null) : base(efl_ui_pager_class_get(), parent)
    {
    ...
    /// <since_tizen> 6 </since_tizen>
    protected Pager(ConstructingHandle ch) : base(ch)
    {
    }
    ...
    internal Pager(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
    ...
    protected Pager(IntPtr baseKlass, CoreUI.Object parent) : base(baseKlass, parent)
    {
    }
    ...
    {
        return CoreUI.UI.Pager.efl_ui_pager_class_get();
    }
