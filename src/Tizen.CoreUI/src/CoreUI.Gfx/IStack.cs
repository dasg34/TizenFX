...
/// <since_tizen> 6 </since_tizen>
[CoreUI.Gfx.StackConcrete.NativeMethods]
    ...
    IStack
{
    ...
    private StackConcrete(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    public void OnStackingChangedEvent()
    {
        CallNativeEventCallback(CoreUI.Libs.CoreUI, "_EFL_GFX_ENTITY_EVENT_STACKING_CHANGED", IntPtr.Zero, null);
    }
...
#pragma warning disable CS0628
    ...
    public short GetLayer() {
        var _ret_var = CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_layer_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public void SetLayer(short l) {
        CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_layer_set_ptr.Value.Delegate(this.NativeHandle, l);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <returns>The <see cref="CoreUI.Gfx.IStack"/> object directly below <c>obj</c>, if any, or <c>null</c>, if none.</returns>
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.Gfx.IStack GetBelow() {
        var _ret_var = CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_below_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <returns>The <see cref="CoreUI.Gfx.IStack"/> object directly below <c>obj</c>, if any, or <c>null</c>, if none.</returns>
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.Gfx.IStack GetAbove() {
        var _ret_var = CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_above_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <param name="below">The object below which to stack</param>
    public void StackBelow(CoreUI.Gfx.IStack below) {
        CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_below_ptr.Value.Delegate(this.NativeHandle, below);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void RaiseToTop() {
        CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_raise_to_top_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <param name="above">The object above which to stack</param>
    public void StackAbove(CoreUI.Gfx.IStack above) {
        CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_above_ptr.Value.Delegate(this.NativeHandle, above);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void LowerToBottom() {
        CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_lower_to_bottom_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning restore CS0628
    ...
    {
        return CoreUI.Gfx.StackConcrete.efl_gfx_stack_interface_get();
    }
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class StackConcreteExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<short> Layer<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Gfx.IStack, T>magic = null) where T : CoreUI.Gfx.IStack {
