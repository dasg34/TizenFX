...
namespace CoreUI {
/// <summary>Event argument wrapper for event <see cref="CoreUI.Loop.ArgumentsEvent"/>.
/// </summary>
...
public abstract class Loop : CoreUI.Task
{
    ...
    /// <summary>Method to raise event IdleEnterEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnIdleEnterEvent()
    {
    ...
    /// <summary>Method to raise event IdleExitEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnIdleExitEvent()
    {
    ...
    /// <summary>Method to raise event IdleEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnIdleEvent()
    {
        CallNativeEventCallback(CoreUI.Libs.Ecore, "_EFL_LOOP_EVENT_IDLE", IntPtr.Zero, null);
    }
    ...
    public event EventHandler<CoreUI.LoopArgumentsEventArgs> ArgumentsEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event ArgumentsEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnArgumentsEvent(CoreUI.LoopArgumentsEventArgs e)
    {
    ...
    /// <summary>Method to raise event PollHighEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPollHighEvent()
    {
    ...
    /// <summary>Method to raise event PollMediumEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPollMediumEvent()
    {
    ...
    /// <summary>Method to raise event PollLowEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPollLowEvent()
    {
    ...
    /// <summary>Method to raise event QuitEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnQuitEvent()
    {
        CallNativeEventCallback(CoreUI.Libs.Ecore, "_EFL_LOOP_EVENT_QUIT", IntPtr.Zero, null);
    }
...
public static class LoopExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> Throttle<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Loop, T>magic = null) where T : CoreUI.Loop {
        return new CoreUI.BindableProperty<double>("throttle", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> Time<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Loop, T>magic = null) where T : CoreUI.Loop {
        return new CoreUI.BindableProperty<double>("time", fac);
    }
...
public struct LoopArguments : IEquatable<LoopArguments>
{
    ...
    /// <since_tizen> 6 </since_tizen>
    public IList<CoreUI.DataTypes.Stringshare> Argv;
    ...
    ///</summary>
    public static implicit operator LoopArguments(
        (
         IList<CoreUI.DataTypes.Stringshare> Argv,
         bool Initialization
        ) tuple)
    {
        return new LoopArguments{
            Argv = tuple.Argv,
    ...
    internal struct NativeStruct
    {
        ...
        public static implicit operator LoopArguments.NativeStruct(LoopArguments _external_struct)
        {
            ...
            _internal_struct.Argv = CoreUI.Wrapper.Globals.IListToNativeArray(_external_struct.Argv, false);
        ...
        public static implicit operator LoopArguments(LoopArguments.NativeStruct _internal_struct)
        {
            ...
            _external_struct.Argv = CoreUI.Wrapper.Globals.NativeArrayToIList<CoreUI.DataTypes.Stringshare>(_internal_struct.Argv);
