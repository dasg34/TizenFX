...
[CoreUI.Layout.CalcConcrete.NativeMethods]
    ...
    CoreUI.Wrapper.IWrapper, IDisposable
{
    ...
    event EventHandler<CoreUI.Layout.CalcCircularDependencyEventArgs> CircularDependencyEvent;
    /// <summary>Whether this object updates its size hints automatically.
    /// 
    /// By default edje doesn&apos;t set size hints on itself. If this property is set to <c>true</c>, size hints will be updated after recalculation. Be careful, as recalculation may happen often, enabling this property may have a considerable performance impact as other widgets will be notified of the size hints changes.
    /// 
...
/// <summary>Event argument wrapper for event <see cref="CoreUI.Layout.ICalc.CircularDependencyEvent"/>.
/// </summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.Wrapper.BindingEntity]
    ...
    ICalc
{
    ...
    private CalcConcrete(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
    ...
    public event EventHandler RecalcEvent
    {
        add
        {
            ...
            AddNativeEventHandler(CoreUI.Libs.Edje, key, callerCb, value);
        }

        remove
        {
            string key = "_EFL_LAYOUT_EVENT_RECALC";
            RemoveNativeEventHandler(CoreUI.Libs.Edje, key, value);
        }
    }
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    public void OnRecalcEvent()
    {
        CallNativeEventCallback(CoreUI.Libs.Edje, "_EFL_LAYOUT_EVENT_RECALC", IntPtr.Zero, null);
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    public void OnCircularDependencyEvent(CoreUI.Layout.CalcCircularDependencyEventArgs e)
    {
        IntPtr info = CoreUI.Wrapper.Globals.IListToNativeArray(e.arg, false);
        CallNativeEventCallback(CoreUI.Libs.Edje, "_EFL_LAYOUT_EVENT_CIRCULAR_DEPENDENCY", info, null);
    }
...
#pragma warning disable CS0628
    ...
    public bool GetCalcAutoUpdateHints() {
        var _ret_var = CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_auto_update_hints_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public void SetCalcAutoUpdateHints(bool update) {
        CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_auto_update_hints_set_ptr.Value.Delegate(this.NativeHandle, update);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <param name="restricted">The minimum size constraint as input, the returned size can not be lower than this (in both directions).</param>
    /// <returns>The minimum required size.</returns>
    public CoreUI.DataTypes.Size2D CalcSizeMin(CoreUI.DataTypes.Size2D restricted) {
        CoreUI.DataTypes.Size2D.NativeStruct _in_restricted = restricted;
var _ret_var = CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_size_min_ptr.Value.Delegate(this.NativeHandle, _in_restricted);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <returns>The calculated region.</returns>
    public CoreUI.DataTypes.Rect CalcPartsExtends() {
        var _ret_var = CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_parts_extends_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public int FreezeCalc() {
        var _ret_var = CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_freeze_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <returns>The frozen state or 0 if the object is not frozen or on error.</returns>
    public int ThawCalc() {
        var _ret_var = CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_thaw_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected void CalcForce() {
        CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_force_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning restore CS0628
    ...
    {
        return CoreUI.Layout.CalcConcrete.efl_layout_calc_interface_get();
    }
    ...
    /// </summary>
        ...
        private delegate CoreUI.DataTypes.Size2D.NativeStruct efl_layout_calc_size_min_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Size2D.NativeStruct restricted);

        
        internal delegate CoreUI.DataTypes.Size2D.NativeStruct efl_layout_calc_size_min_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Size2D.NativeStruct restricted);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Size2D.NativeStruct calc_size_min(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Size2D.NativeStruct restricted)
        {
...
CoreUI.DataTypes.Size2D _ret_var = default(CoreUI.DataTypes.Size2D);
        ...
        private delegate CoreUI.DataTypes.Rect.NativeStruct efl_layout_calc_parts_extends_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Rect.NativeStruct efl_layout_calc_parts_extends_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Rect.NativeStruct calc_parts_extends(System.IntPtr obj, System.IntPtr pd)
        {
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class CalcConcreteExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> CalcAutoUpdateHints<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Layout.ICalc, T>magic = null) where T : CoreUI.Layout.ICalc {
