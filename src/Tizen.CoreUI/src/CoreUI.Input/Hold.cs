...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class HoldExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> InputHold<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Hold, T>magic = null) where T : CoreUI.Input.Hold {
        return new CoreUI.BindableProperty<bool>("input_hold", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> Timestamp<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Hold, T>magic = null) where T : CoreUI.Input.Hold {
        return new CoreUI.BindableProperty<double>("timestamp", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Input.Device> Device<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Hold, T>magic = null) where T : CoreUI.Input.Hold {
        return new CoreUI.BindableProperty<CoreUI.Input.Device>("device", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Input.Flags> EventFlags<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Hold, T>magic = null) where T : CoreUI.Input.Hold {
        return new CoreUI.BindableProperty<CoreUI.Input.Flags>("event_flags", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Processed<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Hold, T>magic = null) where T : CoreUI.Input.Hold {
        return new CoreUI.BindableProperty<bool>("processed", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Scrolling<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Hold, T>magic = null) where T : CoreUI.Input.Hold {
