...
/// <param name="index">Position of this object in the parent model. See <see cref="CoreUI.CompositeModel.SetIndex" /></param>
    ...
    /// <summary>Automatically update the field for the event <see cref="CoreUI.IModel.PropertiesChangedEvent"/> to include property that are impacted with change in a property from the composited model.
    /// 
    ...
    /// <summary>Stop automatically updating the field for the event <see cref="CoreUI.IModel.PropertiesChangedEvent"/> to include property that are impacted with change in a property from the composited model.</summary>
    /// <since_tizen> 6 </since_tizen>
    /// <param name="source">Property name in the composited model.</param>
    /// <param name="destination">Property name in the <see cref="CoreUI.UI.ViewModel"/></param>
...
public static class ViewModelExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> ChildrenBind<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.ViewModel, T>magic = null) where T : CoreUI.UI.ViewModel {
        return new CoreUI.BindableProperty<bool>("children_bind", fac);
    }
