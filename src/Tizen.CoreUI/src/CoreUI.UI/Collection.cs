...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollStartedEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollChangedEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollFinishedEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollUpEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollDownEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollLeftEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollRightEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnEdgeUpEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnEdgeDownEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnEdgeLeftEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnEdgeRightEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollAnimStartedEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollAnimFinishedEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollDragStartedEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollDragFinishedEvent()
    {
    ...
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnScrollDestinationFinalizedEvent(CoreUI.UI.ScrollableScrollDestinationFinalizedEventArgs e)
    {
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnBarPressedEvent(CoreUI.UI.ScrollBarBarPressedEventArgs e)
    {
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnBarUnpressedEvent(CoreUI.UI.ScrollBarBarUnpressedEventArgs e)
    {
        IntPtr info = CoreUI.DataTypes.PrimitiveConversion.ManagedToPointerAlloc(e.arg);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnBarDraggedEvent(CoreUI.UI.ScrollBarBarDraggedEventArgs e)
    {
        IntPtr info = CoreUI.DataTypes.PrimitiveConversion.ManagedToPointerAlloc(e.arg);
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnBarSizeChangedEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnBarPosChangedEvent()
    {
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnBarShowEvent(CoreUI.UI.ScrollBarBarShowEventArgs e)
    {
        IntPtr info = CoreUI.DataTypes.PrimitiveConversion.ManagedToPointerAlloc(e.arg);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnBarHideEvent(CoreUI.UI.ScrollBarBarHideEventArgs e)
    {
        IntPtr info = CoreUI.DataTypes.PrimitiveConversion.ManagedToPointerAlloc(e.arg);
    ...
    public virtual bool ClearPack() {
        var _ret_var = CoreUI.PackConcrete.NativeMethods.efl_pack_clear_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool UnpackAll() {
        var _ret_var = CoreUI.PackConcrete.NativeMethods.efl_pack_unpack_all_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool Unpack(CoreUI.Gfx.IEntity subobj) {
        var _ret_var = CoreUI.PackConcrete.NativeMethods.efl_pack_unpack_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), subobj);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool Pack(CoreUI.Gfx.IEntity subobj) {
        var _ret_var = CoreUI.PackConcrete.NativeMethods.efl_pack_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), subobj);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool PackBegin(CoreUI.Gfx.IEntity subobj) {
        var _ret_var = CoreUI.PackLinearConcrete.NativeMethods.efl_pack_begin_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), subobj);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool PackEnd(CoreUI.Gfx.IEntity subobj) {
        var _ret_var = CoreUI.PackLinearConcrete.NativeMethods.efl_pack_end_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), subobj);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool PackBefore(CoreUI.Gfx.IEntity subobj, CoreUI.Gfx.IEntity existing) {
        var _ret_var = CoreUI.PackLinearConcrete.NativeMethods.efl_pack_before_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), subobj, existing);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool PackAfter(CoreUI.Gfx.IEntity subobj, CoreUI.Gfx.IEntity existing) {
        var _ret_var = CoreUI.PackLinearConcrete.NativeMethods.efl_pack_after_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), subobj, existing);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool PackAt(CoreUI.Gfx.IEntity subobj, int index) {
        var _ret_var = CoreUI.PackLinearConcrete.NativeMethods.efl_pack_at_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), subobj, index);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.Gfx.IEntity GetPackContent(int index) {
        var _ret_var = CoreUI.PackLinearConcrete.NativeMethods.efl_pack_content_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), index);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual int GetPackIndex(CoreUI.Gfx.IEntity subobj) {
        var _ret_var = CoreUI.PackLinearConcrete.NativeMethods.efl_pack_index_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), subobj);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.Gfx.IEntity PackUnpackAt(int index) {
        var _ret_var = CoreUI.PackLinearConcrete.NativeMethods.efl_pack_unpack_at_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), index);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.UI.LayoutOrientation GetOrientation() {
        var _ret_var = CoreUI.UI.LayoutOrientableConcrete.NativeMethods.efl_ui_layout_orientation_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetOrientation(CoreUI.UI.LayoutOrientation dir) {
        CoreUI.UI.LayoutOrientableConcrete.NativeMethods.efl_ui_layout_orientation_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), dir);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.UI.SelectMode GetSelectMode() {
        var _ret_var = CoreUI.UI.MultiSelectableConcrete.NativeMethods.efl_ui_multi_selectable_select_mode_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetSelectMode(CoreUI.UI.SelectMode mode) {
        CoreUI.UI.MultiSelectableConcrete.NativeMethods.efl_ui_multi_selectable_select_mode_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), mode);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SelectAll() {
        CoreUI.UI.MultiSelectableConcrete.NativeMethods.efl_ui_multi_selectable_all_select_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void UnselectAll() {
        CoreUI.UI.MultiSelectableConcrete.NativeMethods.efl_ui_multi_selectable_all_unselect_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual IEnumerable<CoreUI.UI.ISelectable> NewSelectedIterator() {
        var _ret_var = CoreUI.UI.MultiSelectableObjectRangeConcrete.NativeMethods.efl_ui_multi_selectable_selected_iterator_new_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Position2D GetContentPos() {
        var _ret_var = CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_content_pos_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_content_pos_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_pos);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Size2D GetContentSize() {
        var _ret_var = CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_content_size_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Rect GetViewportGeometry() {
        var _ret_var = CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_viewport_geometry_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void GetBounceEnabled(out bool horiz, out bool vert) {
        CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_bounce_enabled_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out horiz, out vert);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetBounceEnabled(bool horiz, bool vert) {
        CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_bounce_enabled_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), horiz, vert);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetScrollFreeze() {
        var _ret_var = CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_scroll_freeze_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetScrollFreeze(bool freeze) {
        CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_scroll_freeze_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), freeze);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetScrollHold() {
        var _ret_var = CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_scroll_hold_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetScrollHold(bool hold) {
        CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_scroll_hold_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), hold);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetLooping(out bool loop_h, out bool loop_v) {
        CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_looping_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out loop_h, out loop_v);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetLooping(bool loop_h, bool loop_v) {
        CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_looping_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), loop_h, loop_v);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.UI.LayoutOrientation GetMovementBlock() {
        var _ret_var = CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_movement_block_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetMovementBlock(CoreUI.UI.LayoutOrientation block) {
        CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_movement_block_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), block);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetGravity(out double x, out double y) {
        CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_gravity_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out x, out y);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetGravity(double x, double y) {
        CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_gravity_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), x, y);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetMatchContent(bool w, bool h) {
        CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_match_content_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), w, h);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Position2D GetStepSize() {
        var _ret_var = CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_step_size_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_step_size_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_step);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
CoreUI.UI.ScrollableConcrete.NativeMethods.efl_ui_scrollable_scroll_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_rect, animation);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetBarMode(out CoreUI.UI.ScrollBarMode hbar, out CoreUI.UI.ScrollBarMode vbar) {
        CoreUI.UI.ScrollBarConcrete.NativeMethods.efl_ui_scrollbar_bar_mode_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out hbar, out vbar);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetBarMode(CoreUI.UI.ScrollBarMode hbar, CoreUI.UI.ScrollBarMode vbar) {
        CoreUI.UI.ScrollBarConcrete.NativeMethods.efl_ui_scrollbar_bar_mode_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), hbar, vbar);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetBarSize(out double width, out double height) {
        CoreUI.UI.ScrollBarConcrete.NativeMethods.efl_ui_scrollbar_bar_size_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out width, out height);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetBarPosition(out double posx, out double posy) {
        CoreUI.UI.ScrollBarConcrete.NativeMethods.efl_ui_scrollbar_bar_position_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out posx, out posy);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetBarPosition(double posx, double posy) {
        CoreUI.UI.ScrollBarConcrete.NativeMethods.efl_ui_scrollbar_bar_position_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), posx, posy);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
public static class CollectionExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.PositionManager.IEntity> PositionManager<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Collection, T>magic = null) where T : CoreUI.UI.Collection {
        return new CoreUI.BindableProperty<CoreUI.UI.PositionManager.IEntity>("position_manager", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation> Orientation<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Collection, T>magic = null) where T : CoreUI.UI.Collection {
        return new CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation>("orientation", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.SelectMode> SelectMode<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Collection, T>magic = null) where T : CoreUI.UI.Collection {
        return new CoreUI.BindableProperty<CoreUI.UI.SelectMode>("select_mode", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Position2D> ContentPos<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Collection, T>magic = null) where T : CoreUI.UI.Collection {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Position2D>("content_pos", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> ScrollFreeze<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Collection, T>magic = null) where T : CoreUI.UI.Collection {
        return new CoreUI.BindableProperty<bool>("scroll_freeze", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> ScrollHold<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Collection, T>magic = null) where T : CoreUI.UI.Collection {
        return new CoreUI.BindableProperty<bool>("scroll_hold", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation> MovementBlock<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Collection, T>magic = null) where T : CoreUI.UI.Collection {
        return new CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation>("movement_block", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Position2D> StepSize<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Collection, T>magic = null) where T : CoreUI.UI.Collection {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Position2D>("step_size", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.ISelectable> FallbackSelection<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Collection, T>magic = null) where T : CoreUI.UI.Collection {
