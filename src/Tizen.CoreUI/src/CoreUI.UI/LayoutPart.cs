...
[CoreUI.UI.LayoutPart.NativeMethods]
[CoreUI.Wrapper.BindingEntity]
[SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
public class LayoutPart : CoreUI.UI.WidgetPart
{
    ...
    /// <since_tizen> 6 </since_tizen>
    public LayoutPart(CoreUI.Object parent= null) : base(efl_ui_layout_part_class_get(), parent)
    {
        FinishInstantiation();
    }
    ...
    internal LayoutPart(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
    ...
    protected LayoutPart(IntPtr baseKlass, CoreUI.Object parent) : base(baseKlass, parent)
    {
    }
    ...
    {
        return CoreUI.UI.LayoutPart.efl_ui_layout_part_class_get();
    }
