...
namespace CoreUI
{
    ...
    {
        /// <summary>
        /// The CircleList is a widget to display and handle the genlist items by the rotary event.
        /// </summary>
        /// <since_tizen> 6 </since_tizen>
        public class CircleList : CoreUI.UI.List, ICircleWidget
        {
            IntPtr _handle;
            ...
            /// <summary>
            /// Creates and initializes a new instance of the CircleList class.
            /// </summary>
            /// <param name="parent">The CoreUI.UI.Widget to which the new CircleList will be attached as a child.</param>
            /// <since_tizen> 6 </since_tizen>
            public CircleList(CoreUI.Object parent) : base(parent)
            {
                ...
                this.ScrollDestinationFinalizedEvent += (object sender, CoreUI.UI.ScrollableScrollDestinationFinalizedEventArgs e) =>
                {
                    ...
                    CoreUI.Wearable.CircleList list = sender as CircleList;
