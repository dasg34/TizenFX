...
/// <param name="itemClass">Define the class of the item returned by this factory. See <see cref="CoreUI.UI.WidgetFactory.SetItemClass" /></param>
    ...
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnItemConstructingEvent(CoreUI.UI.FactoryItemConstructingEventArgs e)
    {
...
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_UI_FACTORY_EVENT_ITEM_CONSTRUCTING", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnItemBuildingEvent(CoreUI.UI.FactoryItemBuildingEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_UI_FACTORY_EVENT_ITEM_BUILDING", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnItemCreatedEvent(CoreUI.UI.FactoryItemCreatedEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_UI_FACTORY_EVENT_ITEM_CREATED", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnItemReleasingEvent(CoreUI.UI.FactoryItemReleasingEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
...
var _ret_var = CoreUI.UI.FactoryConcrete.NativeMethods.efl_ui_factory_create_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_models);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
CoreUI.UI.FactoryConcrete.NativeMethods.efl_ui_factory_release_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_ui_views);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class WidgetFactoryExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<Type> ItemClass<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetFactory, T>magic = null) where T : CoreUI.UI.WidgetFactory {
        return new CoreUI.BindableProperty<Type>("item_class", fac);
    }
