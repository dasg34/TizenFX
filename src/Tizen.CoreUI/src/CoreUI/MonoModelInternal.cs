...
/// 
/// This represents the root model, containing <span class="text-muted">CoreUI.MonoModelInternalChild (object still in beta stage)</span> elements. It is inherited from classes like the C#-only CoreUI.UserModel&lt;T&gt;, which the end user will actually instantiate.</summary>
...
public class MonoModelInternal : CoreUI.LoopConsumer, CoreUI.IModel
{
    ...
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPropertiesChangedEvent(CoreUI.ModelPropertiesChangedEventArgs e)
    {
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnChildAddedEvent(CoreUI.ModelChildAddedEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnChildRemovedEvent(CoreUI.ModelChildRemovedEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnChildrenCountChangedEvent()
    {
    ...
    public virtual IEnumerable<System.String> GetProperties() {
        var _ret_var = CoreUI.ModelConcrete.NativeMethods.efl_model_properties_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Value GetProperty(System.String property) {
        var _ret_var = CoreUI.ModelConcrete.NativeMethods.efl_model_property_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), property);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual  CoreUI.DataTypes.Future SetProperty(System.String property, CoreUI.DataTypes.Value value) {
        var _ret_var = CoreUI.ModelConcrete.NativeMethods.efl_model_property_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), property, value);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual uint GetChildrenCount() {
        var _ret_var = CoreUI.ModelConcrete.NativeMethods.efl_model_children_count_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual  CoreUI.DataTypes.Future GetPropertyReady(System.String property) {
        var _ret_var = CoreUI.ModelConcrete.NativeMethods.efl_model_property_ready_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), property);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual  CoreUI.DataTypes.Future GetChildrenSlice(uint start, uint count) {
        var _ret_var = CoreUI.ModelConcrete.NativeMethods.efl_model_children_slice_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), start, count);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.Object AddChild() {
        var _ret_var = CoreUI.ModelConcrete.NativeMethods.efl_model_child_add_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void DelChild(CoreUI.Object child) {
        CoreUI.ModelConcrete.NativeMethods.efl_model_child_del_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), child);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
