...
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_CONTENT_EVENT_CONTENT_CHANGED", info, null);
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnRepeatedEvent()
    {
    ...
    public virtual double GetAutorepeatInitialTimeout() {
        var _ret_var = CoreUI.UI.AutoRepeatConcrete.NativeMethods.efl_ui_autorepeat_initial_timeout_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetAutorepeatInitialTimeout(double t) {
        CoreUI.UI.AutoRepeatConcrete.NativeMethods.efl_ui_autorepeat_initial_timeout_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), t);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual double GetAutorepeatGapTimeout() {
        var _ret_var = CoreUI.UI.AutoRepeatConcrete.NativeMethods.efl_ui_autorepeat_gap_timeout_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetAutorepeatGapTimeout(double t) {
        CoreUI.UI.AutoRepeatConcrete.NativeMethods.efl_ui_autorepeat_gap_timeout_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), t);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetAutorepeatEnabled() {
        var _ret_var = CoreUI.UI.AutoRepeatConcrete.NativeMethods.efl_ui_autorepeat_enabled_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetAutorepeatEnabled(bool on) {
        CoreUI.UI.AutoRepeatConcrete.NativeMethods.efl_ui_autorepeat_enabled_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), on);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
public static class ButtonExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Button, T>magic = null) where T : CoreUI.UI.Button {
        return new CoreUI.BindableProperty<CoreUI.Gfx.IEntity>("content", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Text<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Button, T>magic = null) where T : CoreUI.UI.Button {
        return new CoreUI.BindableProperty<System.String>("text", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> AutorepeatInitialTimeout<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Button, T>magic = null) where T : CoreUI.UI.Button {
        return new CoreUI.BindableProperty<double>("autorepeat_initial_timeout", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> AutorepeatGapTimeout<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Button, T>magic = null) where T : CoreUI.UI.Button {
        return new CoreUI.BindableProperty<double>("autorepeat_gap_timeout", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> AutorepeatEnabled<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Button, T>magic = null) where T : CoreUI.UI.Button {
