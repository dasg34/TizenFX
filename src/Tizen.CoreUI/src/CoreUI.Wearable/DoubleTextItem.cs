...
/// <summary>Wearable Double Text Item Class.</summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.Wearable.DoubleTextItem.NativeMethods]
[CoreUI.Wrapper.BindingEntity]
[SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
public class DoubleTextItem : CoreUI.Wearable.Item, CoreUI.IContent, CoreUI.IText
{
    ...
    public override System.IntPtr NativeClass
    {
        get
        {
            if (((object)this).GetType() == typeof(DoubleTextItem))
            {
    ...
    [System.Runtime.InteropServices.DllImport(CoreUI.Libs.Elementary)] internal static extern System.IntPtr
        efl_wearable_double_text_item_class_get();

    /// <summary>Initializes a new instance of the <see cref="DoubleTextItem"/> class.
    /// </summary>
    /// <param name="parent">Parent instance.</param>
    /// <since_tizen> 6 </since_tizen>
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    public DoubleTextItem(CoreUI.Object parent, System.String style = null) : base(efl_wearable_double_text_item_class_get(), parent)
    {
    ...
    /// <since_tizen> 6 </since_tizen>
    protected DoubleTextItem(ConstructingHandle ch) : base(ch)
    {
    }
    ...
    internal DoubleTextItem(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
    ...
    protected DoubleTextItem(IntPtr baseKlass, CoreUI.Object parent) : base(baseKlass, parent)
    {
    }
...
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_CONTENT_EVENT_CONTENT_CHANGED", info, null);
    ...
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.UI.LayoutPartText SubTextPart
    {
        get
        {
            return GetPart("sub_text") as CoreUI.UI.LayoutPartText;
        }
    }
    /// <summary>The text part for default items. This is the caption of the items.</summary>
    /// <since_tizen> 6 </since_tizen>
    ...
    {
        return CoreUI.Wearable.DoubleTextItem.efl_wearable_double_text_item_class_get();
    }
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class DoubleTextItemExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.DoubleTextItem, T>magic = null) where T : CoreUI.Wearable.DoubleTextItem {
        return new CoreUI.BindableProperty<CoreUI.Gfx.IEntity>("content", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Text<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.DoubleTextItem, T>magic = null) where T : CoreUI.Wearable.DoubleTextItem {
        return new CoreUI.BindableProperty<System.String>("text", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent> ExtraPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.DoubleTextItem, T> x=null) where T : CoreUI.Wearable.DoubleTextItem
    {
        return new CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent>("extra", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent> IconPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.DoubleTextItem, T> x=null) where T : CoreUI.Wearable.DoubleTextItem
    {
        return new CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent>("icon", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindablePart<CoreUI.UI.LayoutPartText> SubTextPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.DoubleTextItem, T> x=null) where T : CoreUI.Wearable.DoubleTextItem
    {
        return new CoreUI.BindablePart<CoreUI.UI.LayoutPartText>("sub_text", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindablePart<CoreUI.UI.LayoutPartText> TextPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.DoubleTextItem, T> x=null) where T : CoreUI.Wearable.DoubleTextItem
    {
