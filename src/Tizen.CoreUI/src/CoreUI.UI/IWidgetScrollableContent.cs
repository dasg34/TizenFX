...
[CoreUI.UI.WidgetScrollableContentConcrete.NativeMethods]
    ...
    IWidgetScrollableContent
{
    ...
    private WidgetScrollableContentConcrete(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    /// <returns>The content object.</returns>
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.Canvas.Object GetScrollableContent() {
        var _ret_var = CoreUI.UI.WidgetScrollableContentConcrete.NativeMethods.efl_ui_widget_scrollable_content_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    /// <returns><c>true</c> on success.</returns>
    /// <since_tizen> 6 </since_tizen>
    public bool SetScrollableContent(CoreUI.Canvas.Object content) {
        var _ret_var = CoreUI.UI.WidgetScrollableContentConcrete.NativeMethods.efl_ui_widget_scrollable_content_set_ptr.Value.Delegate(this.NativeHandle, content);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public System.String GetScrollableText() {
        var _ret_var = CoreUI.UI.WidgetScrollableContentConcrete.NativeMethods.efl_ui_widget_scrollable_text_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetScrollableText(System.String text) {
        CoreUI.UI.WidgetScrollableContentConcrete.NativeMethods.efl_ui_widget_scrollable_text_set_ptr.Value.Delegate(this.NativeHandle, text);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning restore CS0628
    ...
    {
        return CoreUI.UI.WidgetScrollableContentConcrete.efl_ui_widget_scrollable_content_mixin_get();
    }
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class WidgetScrollableContentConcreteExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Canvas.Object> ScrollableContent<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.IWidgetScrollableContent, T>magic = null) where T : CoreUI.UI.IWidgetScrollableContent {
        return new CoreUI.BindableProperty<CoreUI.Canvas.Object>("scrollable_content", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> ScrollableText<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.IWidgetScrollableContent, T>magic = null) where T : CoreUI.UI.IWidgetScrollableContent {
