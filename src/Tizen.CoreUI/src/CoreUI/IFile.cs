...
[CoreUI.FileConcrete.NativeMethods]
    ...
    IFile
{
    ...
    private FileConcrete(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    /// <returns>The handle to the <see cref="CoreUI.DataTypes.File"/> that will be used</returns>
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.DataTypes.File GetMmap() {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_mmap_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    /// <returns>0 on success, error code otherwise</returns>
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.DataTypes.Error SetMmap(CoreUI.DataTypes.File f) {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_mmap_set_ptr.Value.Delegate(this.NativeHandle, f);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public System.String GetFile() {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <returns>0 on success, error code otherwise</returns>
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.DataTypes.Error SetFile(System.String file) {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_set_ptr.Value.Delegate(this.NativeHandle, file);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public System.String GetKey() {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_key_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetKey(System.String key) {
        CoreUI.FileConcrete.NativeMethods.efl_file_key_set_ptr.Value.Delegate(this.NativeHandle, key);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public bool GetLoaded() {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_loaded_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <returns>0 on success, error code otherwise</returns>
    public CoreUI.DataTypes.Error Load() {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_load_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <since_tizen> 6 </since_tizen>
    public void Unload() {
        CoreUI.FileConcrete.NativeMethods.efl_file_unload_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning restore CS0628
    ...
    {
        return CoreUI.FileConcrete.efl_file_mixin_get();
    }
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class FileConcreteExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.File> Mmap<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.IFile, T>magic = null) where T : CoreUI.IFile {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.File>("mmap", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> File<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.IFile, T>magic = null) where T : CoreUI.IFile {
        return new CoreUI.BindableProperty<System.String>("file", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Key<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.IFile, T>magic = null) where T : CoreUI.IFile {
