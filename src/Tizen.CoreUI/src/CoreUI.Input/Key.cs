...
public static class KeyExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Pressed<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Key, T>magic = null) where T : CoreUI.Input.Key {
        return new CoreUI.BindableProperty<bool>("pressed", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> KeyName<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Key, T>magic = null) where T : CoreUI.Input.Key {
        return new CoreUI.BindableProperty<System.String>("key_name", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> KeySym<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Key, T>magic = null) where T : CoreUI.Input.Key {
        return new CoreUI.BindableProperty<System.String>("key_sym", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> String<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Key, T>magic = null) where T : CoreUI.Input.Key {
        return new CoreUI.BindableProperty<System.String>("string", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> ComposeString<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Key, T>magic = null) where T : CoreUI.Input.Key {
        return new CoreUI.BindableProperty<System.String>("compose_string", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<int> KeyCode<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Key, T>magic = null) where T : CoreUI.Input.Key {
        return new CoreUI.BindableProperty<int>("key_code", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> Timestamp<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Key, T>magic = null) where T : CoreUI.Input.Key {
        return new CoreUI.BindableProperty<double>("timestamp", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Input.Device> Device<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Key, T>magic = null) where T : CoreUI.Input.Key {
        return new CoreUI.BindableProperty<CoreUI.Input.Device>("device", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Input.Flags> EventFlags<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Key, T>magic = null) where T : CoreUI.Input.Key {
        return new CoreUI.BindableProperty<CoreUI.Input.Flags>("event_flags", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Processed<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Key, T>magic = null) where T : CoreUI.Input.Key {
        return new CoreUI.BindableProperty<bool>("processed", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Scrolling<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Key, T>magic = null) where T : CoreUI.Input.Key {
