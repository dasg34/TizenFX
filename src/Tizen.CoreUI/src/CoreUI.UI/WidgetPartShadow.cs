...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class WidgetPartShadowExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> ColorCode<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartShadow, T>magic = null) where T : CoreUI.UI.WidgetPartShadow {
