...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    ...
    public event EventHandler<CoreUI.Gfx.ImageImagePreloadStateChangedEventArgs> ImagePreloadStateChangedEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event ImagePreloadStateChangedEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnImagePreloadStateChangedEvent(CoreUI.Gfx.ImageImagePreloadStateChangedEventArgs e)
    {
    ...
    public event EventHandler<CoreUI.Gfx.ImageImageResizedEventArgs> ImageResizedEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event ImageResizedEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnImageResizedEvent(CoreUI.Gfx.ImageImageResizedEventArgs e)
    {
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnClickedEvent(CoreUI.Input.ClickableClickedEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnClickedAnyEvent(CoreUI.Input.ClickableClickedAnyEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPressedEvent(CoreUI.Input.ClickablePressedEventArgs e)
    {
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnUnpressedEvent(CoreUI.Input.ClickableUnpressedEventArgs e)
    {
        IntPtr info = CoreUI.DataTypes.PrimitiveConversion.ManagedToPointerAlloc(e.arg);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnLongpressedEvent(CoreUI.Input.ClickableLongpressedEventArgs e)
    {
        IntPtr info = CoreUI.DataTypes.PrimitiveConversion.ManagedToPointerAlloc(e.arg);
    ...
    /// <summary>Method to raise event RecalcEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnRecalcEvent()
    {
    ...
    public event EventHandler<CoreUI.Layout.CalcCircularDependencyEventArgs> CircularDependencyEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event CircularDependencyEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnCircularDependencyEvent(CoreUI.Layout.CalcCircularDependencyEventArgs e)
    {
    ...
    public virtual CoreUI.DataTypes.File GetMmap() {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_mmap_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Error SetMmap(CoreUI.DataTypes.File f) {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_mmap_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), f);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual System.String GetFile() {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Error SetFile(System.String file) {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), file);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual System.String GetKey() {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_key_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetKey(System.String key) {
        CoreUI.FileConcrete.NativeMethods.efl_file_key_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), key);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetLoaded() {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_loaded_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Error Load() {
        var _ret_var = CoreUI.FileConcrete.NativeMethods.efl_file_load_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void Unload() {
        CoreUI.FileConcrete.NativeMethods.efl_file_unload_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetPlaying() {
        var _ret_var = CoreUI.PlayerConcrete.NativeMethods.efl_player_playing_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool SetPlaying(bool playing) {
        var _ret_var = CoreUI.PlayerConcrete.NativeMethods.efl_player_playing_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), playing);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool GetPaused() {
        var _ret_var = CoreUI.PlayerConcrete.NativeMethods.efl_player_paused_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool SetPaused(bool paused) {
        var _ret_var = CoreUI.PlayerConcrete.NativeMethods.efl_player_paused_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), paused);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetPlaybackPosition(double sec) {
        CoreUI.PlayerConcrete.NativeMethods.efl_player_playback_position_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), sec);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual double GetPlaybackProgress() {
        var _ret_var = CoreUI.PlayerConcrete.NativeMethods.efl_player_playback_progress_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual double GetPlaybackSpeed() {
        var _ret_var = CoreUI.PlayerConcrete.NativeMethods.efl_player_playback_speed_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetPlaybackSpeed(double speed) {
        CoreUI.PlayerConcrete.NativeMethods.efl_player_playback_speed_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), speed);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetContentAlign(out CoreUI.Gfx.Align align_horiz, out CoreUI.Gfx.Align align_vert) {
        CoreUI.Gfx.ArrangementConcrete.NativeMethods.efl_gfx_arrangement_content_align_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out align_horiz, out align_vert);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetContentAlign(CoreUI.Gfx.Align align_horiz, CoreUI.Gfx.Align align_vert) {
        CoreUI.Gfx.ArrangementConcrete.NativeMethods.efl_gfx_arrangement_content_align_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), align_horiz, align_vert);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetContentPadding(out uint pad_horiz, out uint pad_vert) {
        CoreUI.Gfx.ArrangementConcrete.NativeMethods.efl_gfx_arrangement_content_padding_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out pad_horiz, out pad_vert);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetContentPadding(uint pad_horiz, uint pad_vert) {
        CoreUI.Gfx.ArrangementConcrete.NativeMethods.efl_gfx_arrangement_content_padding_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), pad_horiz, pad_vert);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetSmoothScale() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_smooth_scale_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetSmoothScale(bool smooth_scale) {
        CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_smooth_scale_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), smooth_scale);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.Gfx.ImageScaleMethod GetScaleMethod() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_scale_method_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetScaleMethod(CoreUI.Gfx.ImageScaleMethod scale_method) {
        CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_scale_method_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), scale_method);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetCanUpscale() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_can_upscale_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetCanUpscale(bool upscale) {
        CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_can_upscale_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), upscale);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetCanDownscale() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_can_downscale_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetCanDownscale(bool downscale) {
        CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_can_downscale_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), downscale);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual double GetRatio() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_ratio_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Rect GetContentRegion() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_content_region_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void GetBorderInsets(out int l, out int r, out int t, out int b) {
        CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_border_insets_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out l, out r, out t, out b);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetBorderInsets(int l, int r, int t, int b) {
        CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_border_insets_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), l, r, t, b);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual double GetBorderInsetsScale() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_border_insets_scale_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetBorderInsetsScale(double scale) {
        CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_border_insets_scale_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), scale);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.Gfx.CenterFillMode GetCenterFillMode() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_center_fill_mode_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetCenterFillMode(CoreUI.Gfx.CenterFillMode fill) {
        CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_center_fill_mode_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), fill);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_stretch_region_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out _out_horizontal, out _out_vertical);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_stretch_region_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_horizontal, _in_vertical);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Size2D GetImageSize() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_size_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.Gfx.ImageContentHint GetContentHint() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_content_hint_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetContentHint(CoreUI.Gfx.ImageContentHint hint) {
        CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_content_hint_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), hint);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.Gfx.ImageScaleHint GetScaleHint() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_scale_hint_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetScaleHint(CoreUI.Gfx.ImageScaleHint hint) {
        CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_scale_hint_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), hint);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Error GetImageLoadError() {
        var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_load_error_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Size2D GetLoadSize() {
        var _ret_var = CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_size_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_size_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_size);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual double GetLoadDpi() {
        var _ret_var = CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_dpi_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetLoadDpi(double dpi) {
        CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_dpi_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), dpi);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetLoadRegionSupport() {
        var _ret_var = CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_region_support_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Rect GetLoadRegion() {
        var _ret_var = CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_region_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_region_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_region);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetLoadOrientation() {
        var _ret_var = CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_orientation_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetLoadOrientation(bool enable) {
        CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_orientation_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), enable);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual int GetLoadScaleDown() {
        var _ret_var = CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_scale_down_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetLoadScaleDown(int div) {
        CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_scale_down_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), div);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetLoadSkipHeader() {
        var _ret_var = CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_skip_header_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetLoadSkipHeader(bool skip) {
        CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_skip_header_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), skip);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void LoadAsyncStart() {
        CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_async_start_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void CancelLoadAsync() {
        CoreUI.Gfx.ImageLoadControllerConcrete.NativeMethods.efl_gfx_image_load_controller_load_async_cancel_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.Gfx.ImageOrientation GetImageOrientation() {
        var _ret_var = CoreUI.Gfx.ImageOrientableConcrete.NativeMethods.efl_gfx_image_orientation_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetImageOrientation(CoreUI.Gfx.ImageOrientation dir) {
        CoreUI.Gfx.ImageOrientableConcrete.NativeMethods.efl_gfx_image_orientation_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), dir);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetInteraction() {
        var _ret_var = CoreUI.Input.ClickableConcrete.NativeMethods.efl_input_clickable_interaction_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected virtual void Press(uint button) {
        CoreUI.Input.ClickableConcrete.NativeMethods.efl_input_clickable_press_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), button);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    protected virtual void Unpress(uint button) {
        CoreUI.Input.ClickableConcrete.NativeMethods.efl_input_clickable_unpress_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), button);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    protected virtual void ResetButtonState(uint button) {
        CoreUI.Input.ClickableConcrete.NativeMethods.efl_input_clickable_button_state_reset_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), button);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    protected virtual void LongpressAbort(uint button) {
        CoreUI.Input.ClickableConcrete.NativeMethods.efl_input_clickable_longpress_abort_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), button);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetCalcAutoUpdateHints() {
        var _ret_var = CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_auto_update_hints_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetCalcAutoUpdateHints(bool update) {
        CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_auto_update_hints_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), update);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Size2D CalcSizeMin(CoreUI.DataTypes.Size2D restricted) {
        CoreUI.DataTypes.Size2D.NativeStruct _in_restricted = restricted;
var _ret_var = CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_size_min_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_restricted);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Rect CalcPartsExtends() {
        var _ret_var = CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_parts_extends_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual int FreezeCalc() {
        var _ret_var = CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_freeze_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual int ThawCalc() {
        var _ret_var = CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_thaw_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected virtual void CalcForce() {
        CoreUI.Layout.CalcConcrete.NativeMethods.efl_layout_calc_force_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Size2D GetGroupSizeMin() {
        var _ret_var = CoreUI.Layout.GroupConcrete.NativeMethods.efl_layout_group_size_min_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Size2D GetGroupSizeMax() {
        var _ret_var = CoreUI.Layout.GroupConcrete.NativeMethods.efl_layout_group_size_max_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual System.String GetGroupData(System.String key) {
        var _ret_var = CoreUI.Layout.GroupConcrete.NativeMethods.efl_layout_group_data_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), key);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool GetPartExist(System.String part) {
        var _ret_var = CoreUI.Layout.GroupConcrete.NativeMethods.efl_layout_group_part_exist_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), part);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SendMessage(int id, CoreUI.DataTypes.Value msg) {
        CoreUI.Layout.SignalConcrete.NativeMethods.efl_layout_signal_message_send_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), id, msg);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
var _ret_var = CoreUI.Layout.SignalConcrete.NativeMethods.efl_layout_signal_callback_add_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), emission, source, GCHandle.ToIntPtr(func_handle), CoreUILayoutSignalCbWrapper.Cb, CoreUI.Wrapper.Globals.free_gchandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool DelSignalCallback(System.String emission, System.String source, CoreUILayoutSignalCb func) {
        GCHandle func_handle = GCHandle.Alloc(func);
var _ret_var = CoreUI.Layout.SignalConcrete.NativeMethods.efl_layout_signal_callback_del_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), emission, source, GCHandle.ToIntPtr(func_handle), CoreUILayoutSignalCbWrapper.Cb, CoreUI.Wrapper.Globals.free_gchandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void EmitSignal(System.String emission, System.String source) {
        CoreUI.Layout.SignalConcrete.NativeMethods.efl_layout_signal_emit_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), emission, source);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void ProcessSignal(bool recurse) {
        CoreUI.Layout.SignalConcrete.NativeMethods.efl_layout_signal_process_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), recurse);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
public static class ImageExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Icon<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<System.String>("icon", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.File> Mmap<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.File>("mmap", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> File<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<System.String>("file", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Key<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<System.String>("key", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Playing<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<bool>("playing", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Paused<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<bool>("paused", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> PlaybackSpeed<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<double>("playback_speed", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> SmoothScale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<bool>("smooth_scale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleMethod> ScaleMethod<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleMethod>("scale_method", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> CanUpscale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<bool>("can_upscale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> CanDownscale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<bool>("can_downscale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> BorderInsetsScale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<double>("border_insets_scale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.CenterFillMode> CenterFillMode<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<CoreUI.Gfx.CenterFillMode>("center_fill_mode", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.ImageContentHint> ContentHint<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<CoreUI.Gfx.ImageContentHint>("content_hint", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleHint> ScaleHint<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleHint>("scale_hint", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Size2D> LoadSize<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Size2D>("load_size", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> LoadDpi<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<double>("load_dpi", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Rect> LoadRegion<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Rect>("load_region", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> LoadOrientation<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<bool>("load_orientation", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<int> LoadScaleDown<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<int>("load_scale_down", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> LoadSkipHeader<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<bool>("load_skip_header", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.ImageOrientation> ImageOrientation<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<CoreUI.Gfx.ImageOrientation>("image_orientation", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> CalcAutoUpdateHints<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Image, T>magic = null) where T : CoreUI.UI.Image {
        return new CoreUI.BindableProperty<bool>("calc_auto_update_hints", fac);
    }
