...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnMinReachedEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnMaxReachedEvent()
    {
    ...
    public virtual CoreUI.UI.FormatFunc GetFormatFunc() {
        var _ret_var = CoreUI.UI.FormatConcrete.NativeMethods.efl_ui_format_func_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
...
CoreUI.UI.FormatConcrete.NativeMethods.efl_ui_format_func_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), GCHandle.ToIntPtr(func_handle), CoreUI.UI.FormatFuncWrapper.Cb, CoreUI.Wrapper.Globals.free_gchandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual IEnumerable<CoreUI.UI.FormatValue> GetFormatValues() {
        var _ret_var = CoreUI.UI.FormatConcrete.NativeMethods.efl_ui_format_values_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
CoreUI.UI.FormatConcrete.NativeMethods.efl_ui_format_values_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_values);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetFormatString(out System.String kw_string, out CoreUI.UI.FormatStringType type) {
        CoreUI.UI.FormatConcrete.NativeMethods.efl_ui_format_string_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out kw_string, out type);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetFormatString(System.String kw_string, CoreUI.UI.FormatStringType type) {
        CoreUI.UI.FormatConcrete.NativeMethods.efl_ui_format_string_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), kw_string, type);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    protected virtual void GetFormattedValue(CoreUI.DataTypes.Strbuf str, CoreUI.DataTypes.Value value) {
        CoreUI.UI.FormatConcrete.NativeMethods.efl_ui_format_formatted_value_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), str, value);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    protected virtual int GetDecimalPlaces() {
        var _ret_var = CoreUI.UI.FormatConcrete.NativeMethods.efl_ui_format_decimal_places_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected virtual void ApplyFormattedValue() {
        CoreUI.UI.FormatConcrete.NativeMethods.efl_ui_format_apply_formatted_value_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual double GetRangeValue() {
        var _ret_var = CoreUI.UI.RangeDisplayConcrete.NativeMethods.efl_ui_range_value_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetRangeValue(double val) {
        CoreUI.UI.RangeDisplayConcrete.NativeMethods.efl_ui_range_value_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), val);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetRangeLimits(out double min, out double max) {
        CoreUI.UI.RangeDisplayConcrete.NativeMethods.efl_ui_range_limits_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out min, out max);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetRangeLimits(double min, double max) {
        CoreUI.UI.RangeDisplayConcrete.NativeMethods.efl_ui_range_limits_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), min, max);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class SpinExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.FormatFunc> FormatFunc<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Spin, T>magic = null) where T : CoreUI.UI.Spin {
        return new CoreUI.BindableProperty<CoreUI.UI.FormatFunc>("format_func", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<IEnumerable<CoreUI.UI.FormatValue>> FormatValues<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Spin, T>magic = null) where T : CoreUI.UI.Spin {
        return new CoreUI.BindableProperty<IEnumerable<CoreUI.UI.FormatValue>>("format_values", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> RangeValue<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Spin, T>magic = null) where T : CoreUI.UI.Spin {
