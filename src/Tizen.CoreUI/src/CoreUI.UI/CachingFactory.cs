...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class CachingFactoryExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<uint> MemoryLimit<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CachingFactory, T>magic = null) where T : CoreUI.UI.CachingFactory {
        return new CoreUI.BindableProperty<uint>("memory_limit", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<uint> ItemsLimit<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.CachingFactory, T>magic = null) where T : CoreUI.UI.CachingFactory {
        return new CoreUI.BindableProperty<uint>("items_limit", fac);
    }
