...
/// <summary>Wearable Default Item Class.
/// 
...
[CoreUI.Wearable.DefaultItem.NativeMethods]
[CoreUI.Wrapper.BindingEntity]
[SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
public abstract class DefaultItem : CoreUI.Wearable.Item, CoreUI.IContent, CoreUI.IText
{
    ...
    [System.Runtime.InteropServices.DllImport(CoreUI.Libs.Elementary)] internal static extern System.IntPtr
        efl_wearable_default_item_class_get();
...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    public DefaultItem(CoreUI.Object parent, System.String style = null) : base(efl_wearable_default_item_class_get(), parent)
    {
...
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_CONTENT_EVENT_CONTENT_CHANGED", info, null);
    ...
    {
        return CoreUI.Wearable.DefaultItem.efl_wearable_default_item_class_get();
    }
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class DefaultItemExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.DefaultItem, T>magic = null) where T : CoreUI.Wearable.DefaultItem {
        return new CoreUI.BindableProperty<CoreUI.Gfx.IEntity>("content", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Text<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.DefaultItem, T>magic = null) where T : CoreUI.Wearable.DefaultItem {
        return new CoreUI.BindableProperty<System.String>("text", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent> ExtraPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.DefaultItem, T> x=null) where T : CoreUI.Wearable.DefaultItem
    {
        return new CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent>("extra", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent> IconPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.DefaultItem, T> x=null) where T : CoreUI.Wearable.DefaultItem
    {
        return new CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent>("icon", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindablePart<CoreUI.UI.LayoutPartText> TextPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Wearable.DefaultItem, T> x=null) where T : CoreUI.Wearable.DefaultItem
    {
