...
/// <summary>Event argument wrapper for event <see cref="CoreUI.Canvas.Object.AnimatorTickEvent"/>.
/// </summary>
...
public abstract class Object : CoreUI.LoopConsumer, CoreUI.Canvas.IPointer, CoreUI.Gfx.IColor, CoreUI.Gfx.IEntity, CoreUI.Gfx.IHint, CoreUI.Gfx.IMapping, CoreUI.Gfx.IStack, CoreUI.Input.IInterface
{
    ...
    public event EventHandler<CoreUI.Canvas.ObjectAnimatorTickEventArgs> AnimatorTickEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event AnimatorTickEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnAnimatorTickEvent(CoreUI.Canvas.ObjectAnimatorTickEventArgs e)
    {
    ...
    public event EventHandler<CoreUI.Gfx.EntityVisibilityChangedEventArgs> VisibilityChangedEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event VisibilityChangedEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnVisibilityChangedEvent(CoreUI.Gfx.EntityVisibilityChangedEventArgs e)
    {
    ...
    public event EventHandler<CoreUI.Gfx.EntityPositionChangedEventArgs> PositionChangedEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event PositionChangedEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPositionChangedEvent(CoreUI.Gfx.EntityPositionChangedEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
    ...
    public event EventHandler<CoreUI.Gfx.EntitySizeChangedEventArgs> SizeChangedEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event SizeChangedEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnSizeChangedEvent(CoreUI.Gfx.EntitySizeChangedEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnHintsChangedEvent()
    {
    ...
    /// <summary>Method to raise event StackingChangedEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnStackingChangedEvent()
    {
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPointerMoveEvent(CoreUI.Input.InterfacePointerMoveEventArgs e)
    {
...
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_POINTER_MOVE", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPointerDownEvent(CoreUI.Input.InterfacePointerDownEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_POINTER_DOWN", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPointerUpEvent(CoreUI.Input.InterfacePointerUpEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_POINTER_UP", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPointerCancelEvent(CoreUI.Input.InterfacePointerCancelEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_POINTER_CANCEL", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPointerInEvent(CoreUI.Input.InterfacePointerInEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_POINTER_IN", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPointerOutEvent(CoreUI.Input.InterfacePointerOutEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_POINTER_OUT", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPointerWheelEvent(CoreUI.Input.InterfacePointerWheelEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_POINTER_WHEEL", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPointerAxisEvent(CoreUI.Input.InterfacePointerAxisEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_POINTER_AXIS", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnFingerMoveEvent(CoreUI.Input.InterfaceFingerMoveEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_FINGER_MOVE", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnFingerDownEvent(CoreUI.Input.InterfaceFingerDownEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_FINGER_DOWN", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnFingerUpEvent(CoreUI.Input.InterfaceFingerUpEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_FINGER_UP", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnKeyDownEvent(CoreUI.Input.InterfaceKeyDownEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_KEY_DOWN", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnKeyUpEvent(CoreUI.Input.InterfaceKeyUpEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_KEY_UP", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnHoldEvent(CoreUI.Input.InterfaceHoldEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_HOLD", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnFocusInEvent(CoreUI.Input.InterfaceFocusInEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_EVENT_FOCUS_IN", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnFocusOutEvent(CoreUI.Input.InterfaceFocusOutEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
...
var _ret_var = CoreUI.Canvas.Object.NativeMethods.efl_canvas_object_coords_inside_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_pos);
    ...
    public virtual void GetColor(out int r, out int g, out int b, out int a) {
        CoreUI.Gfx.ColorConcrete.NativeMethods.efl_gfx_color_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out r, out g, out b, out a);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetColor(int r, int g, int b, int a) {
        CoreUI.Gfx.ColorConcrete.NativeMethods.efl_gfx_color_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), r, g, b, a);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual System.String GetColorCode() {
        var _ret_var = CoreUI.Gfx.ColorConcrete.NativeMethods.efl_gfx_color_code_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetColorCode(System.String colorcode) {
        CoreUI.Gfx.ColorConcrete.NativeMethods.efl_gfx_color_code_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), colorcode);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Position2D GetPosition() {
        var _ret_var = CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_position_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetPosition(CoreUI.DataTypes.Position2D pos) {
        CoreUI.DataTypes.Position2D.NativeStruct _in_pos = pos;
CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_position_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_pos);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Size2D GetSize() {
        var _ret_var = CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_size_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_size_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_size);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Rect GetGeometry() {
        var _ret_var = CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_geometry_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_geometry_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_rect);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetVisible() {
        var _ret_var = CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_visible_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetVisible(bool v) {
        CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_visible_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), v);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual double GetScale() {
        var _ret_var = CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_scale_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetScale(double scale) {
        CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_scale_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), scale);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_aspect_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out mode, out _out_sz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
sz = _out_sz;
...
CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_aspect_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), mode, _in_sz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Size2D GetHintSizeMax() {
        var _ret_var = CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_max_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetHintSizeMax(CoreUI.DataTypes.Size2D sz) {
        CoreUI.DataTypes.Size2D.NativeStruct _in_sz = sz;
CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_max_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_sz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Size2D GetHintSizeRestrictedMax() {
        var _ret_var = CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_restricted_max_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected virtual void SetHintSizeRestrictedMax(CoreUI.DataTypes.Size2D sz) {
        CoreUI.DataTypes.Size2D.NativeStruct _in_sz = sz;
CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_restricted_max_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_sz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Size2D GetHintSizeCombinedMax() {
        var _ret_var = CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_combined_max_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Size2D GetHintSizeMin() {
        var _ret_var = CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_min_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetHintSizeMin(CoreUI.DataTypes.Size2D sz) {
        CoreUI.DataTypes.Size2D.NativeStruct _in_sz = sz;
CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_min_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_sz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Size2D GetHintSizeRestrictedMin() {
        var _ret_var = CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_restricted_min_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    protected virtual void SetHintSizeRestrictedMin(CoreUI.DataTypes.Size2D sz) {
        CoreUI.DataTypes.Size2D.NativeStruct _in_sz = sz;
CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_restricted_min_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_sz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.DataTypes.Size2D GetHintSizeCombinedMin() {
        var _ret_var = CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_size_combined_min_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void GetHintMargin(out int l, out int r, out int t, out int b) {
        CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_margin_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out l, out r, out t, out b);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetHintMargin(int l, int r, int t, int b) {
        CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_margin_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), l, r, t, b);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetHintWeight(out double x, out double y) {
        CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_weight_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out x, out y);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetHintWeight(double x, double y) {
        CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_weight_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), x, y);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetHintAlign(out CoreUI.Gfx.Align x, out CoreUI.Gfx.Align y) {
        CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_align_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out x, out y);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetHintAlign(CoreUI.Gfx.Align x, CoreUI.Gfx.Align y) {
        CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_align_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), x, y);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetHintFill(out bool x, out bool y) {
        CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_fill_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out x, out y);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetHintFill(bool x, bool y) {
        CoreUI.Gfx.HintConcrete.NativeMethods.efl_gfx_hint_fill_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), x, y);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual int GetMappingPointCount() {
        var _ret_var = CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_point_count_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetMappingPointCount(int count) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_point_count_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), count);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetMappingClockwise() {
        var _ret_var = CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_clockwise_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool GetMappingSmooth() {
        var _ret_var = CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_smooth_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetMappingSmooth(bool smooth) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_smooth_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), smooth);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetMappingAlpha() {
        var _ret_var = CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_alpha_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetMappingAlpha(bool alpha) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_alpha_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), alpha);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetMappingCoordAbsolute(int idx, out double x, out double y, out double z) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_coord_absolute_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), idx, out x, out y, out z);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetMappingCoordAbsolute(int idx, double x, double y, double z) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_coord_absolute_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), idx, x, y, z);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetMappingUv(int idx, out double u, out double v) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_uv_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), idx, out u, out v);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetMappingUv(int idx, double u, double v) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_uv_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), idx, u, v);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void GetMappingColor(int idx, out int r, out int g, out int b, out int a) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_color_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), idx, out r, out g, out b, out a);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetMappingColor(int idx, int r, int g, int b, int a) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_color_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), idx, r, g, b, a);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool HasMapping() {
        var _ret_var = CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_has_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void ResetMapping() {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_reset_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void Translate(double dx, double dy, double dz) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_translate_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), dx, dy, dz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void Rotate(double degrees, CoreUI.Gfx.IEntity pivot, double cx, double cy) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), degrees, pivot, cx, cy);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void Rotate3d(double dx, double dy, double dz, CoreUI.Gfx.IEntity pivot, double cx, double cy, double cz) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_3d_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), dx, dy, dz, pivot, cx, cy, cz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void RotateQuat(double qx, double qy, double qz, double qw, CoreUI.Gfx.IEntity pivot, double cx, double cy, double cz) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_quat_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), qx, qy, qz, qw, pivot, cx, cy, cz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void Zoom(double zoomx, double zoomy, CoreUI.Gfx.IEntity pivot, double cx, double cy) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_zoom_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), zoomx, zoomy, pivot, cx, cy);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void Lighting3d(CoreUI.Gfx.IEntity pivot, double lx, double ly, double lz, int lr, int lg, int lb, int ar, int ag, int ab) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_lighting_3d_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), pivot, lx, ly, lz, lr, lg, lb, ar, ag, ab);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void Perspective3d(CoreUI.Gfx.IEntity pivot, double px, double py, double z0, double foc) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_perspective_3d_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), pivot, px, py, z0, foc);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void RotateAbsolute(double degrees, double cx, double cy) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_absolute_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), degrees, cx, cy);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void Rotate3dAbsolute(double dx, double dy, double dz, double cx, double cy, double cz) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_3d_absolute_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), dx, dy, dz, cx, cy, cz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void RotateQuatAbsolute(double qx, double qy, double qz, double qw, double cx, double cy, double cz) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_quat_absolute_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), qx, qy, qz, qw, cx, cy, cz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void ZoomAbsolute(double zoomx, double zoomy, double cx, double cy) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_zoom_absolute_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), zoomx, zoomy, cx, cy);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void Lighting3dAbsolute(double lx, double ly, double lz, int lr, int lg, int lb, int ar, int ag, int ab) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_lighting_3d_absolute_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), lx, ly, lz, lr, lg, lb, ar, ag, ab);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void Perspective3dAbsolute(double px, double py, double z0, double foc) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_perspective_3d_absolute_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), px, py, z0, foc);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual short GetLayer() {
        var _ret_var = CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_layer_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetLayer(short l) {
        CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_layer_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), l);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.Gfx.IStack GetBelow() {
        var _ret_var = CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_below_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.Gfx.IStack GetAbove() {
        var _ret_var = CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_above_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void StackBelow(CoreUI.Gfx.IStack below) {
        CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_below_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), below);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void RaiseToTop() {
        CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_raise_to_top_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void StackAbove(CoreUI.Gfx.IStack above) {
        CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_above_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), above);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void LowerToBottom() {
        CoreUI.Gfx.StackConcrete.NativeMethods.efl_gfx_stack_lower_to_bottom_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// </summary>
        ...
        [return: MarshalAs(UnmanagedType.U1)]
        private delegate bool efl_canvas_object_coords_inside_get_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Position2D.NativeStruct pos);

        [return: MarshalAs(UnmanagedType.U1)]
        internal delegate bool efl_canvas_object_coords_inside_get_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Position2D.NativeStruct pos);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static bool coords_inside_get(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Position2D.NativeStruct pos)
        {
...
bool _ret_var = default(bool);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static void hint_size_restricted_max_set(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Size2D.NativeStruct sz)
        {
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static void hint_size_restricted_min_set(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Size2D.NativeStruct sz)
        {
...
public static class ObjectExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.RenderOp> RenderOp<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<CoreUI.Gfx.RenderOp>("render_op", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Canvas.Object> Clipper<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<CoreUI.Canvas.Object>("clipper", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> RepeatEvents<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<bool>("repeat_events", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> KeyFocus<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<bool>("key_focus", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> PreciseIsInside<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<bool>("precise_is_inside", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> PropagateEvents<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<bool>("propagate_events", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> PassEvents<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<bool>("pass_events", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> AntiAlias<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<bool>("anti_alias", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.TextBidirectionalType> ParagraphDirection<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<CoreUI.TextBidirectionalType>("paragraph_direction", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> NoRender<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<bool>("no_render", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> ColorCode<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<System.String>("color_code", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Position2D> Position<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Position2D>("position", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Size2D> Size<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Size2D>("size", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Rect> Geometry<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Rect>("geometry", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Visible<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<bool>("visible", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> Scale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<double>("scale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Size2D> HintSizeMax<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Size2D>("hint_size_max", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Size2D> HintSizeRestrictedMax<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Size2D>("hint_size_restricted_max", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Size2D> HintSizeMin<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Size2D>("hint_size_min", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Size2D> HintSizeRestrictedMin<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Size2D>("hint_size_restricted_min", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<int> MappingPointCount<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<int>("mapping_point_count", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> MappingSmooth<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<bool>("mapping_smooth", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> MappingAlpha<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<bool>("mapping_alpha", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<short> Layer<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Object, T>magic = null) where T : CoreUI.Canvas.Object {
        return new CoreUI.BindableProperty<short>("layer", fac);
    }
...
public struct EventAnimatorTick : IEquatable<EventAnimatorTick>
{
    ...
    public CoreUI.DataTypes.Rect Update_area;
    ...
    public EventAnimatorTick(
        CoreUI.DataTypes.Rect Update_area = default(CoreUI.DataTypes.Rect)    )
    {
    ...
    public void Deconstruct(
        out CoreUI.DataTypes.Rect Update_area
    )
    {
    ...
    {
        int hash = 17;
        hash = hash * 23 + Update_area.GetHashCode();
        return hash;
    }
    ...
    {
        return Update_area == other.Update_area        ;
    }
    /// <summary>Equality comparison.
    /// </summary>
    ...
    internal struct NativeStruct
    {
        ...
        public CoreUI.DataTypes.Rect.NativeStruct Update_area;
