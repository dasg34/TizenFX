...
/// 
/// Some events are converted to edje signals so the theme can react to them: <see cref="CoreUI.Input.IClickable.PressedEvent"/> -&gt; &quot;efl,state,pressed&quot;, <see cref="CoreUI.Input.IClickable.UnpressedEvent"/> -&gt; &quot;efl,state,unpressed&quot;, <see cref="CoreUI.UI.ISelectable.SelectedChangedEvent"/> (true) -&gt; &quot;efl,state,selected&quot;, <see cref="CoreUI.UI.ISelectable.SelectedChangedEvent"/> (false) -&gt; &quot;efl,state,unselected&quot;.
/// 
...
public static class ItemExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.Widget> Container<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Item, T>magic = null) where T : CoreUI.UI.Item {
        return new CoreUI.BindableProperty<CoreUI.UI.Widget>("container", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.Item> ItemParent<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Item, T>magic = null) where T : CoreUI.UI.Item {
        return new CoreUI.BindableProperty<CoreUI.UI.Item>("item_parent", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> CalcLocked<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Item, T>magic = null) where T : CoreUI.UI.Item {
        return new CoreUI.BindableProperty<bool>("calc_locked", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Selected<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Item, T>magic = null) where T : CoreUI.UI.Item {
