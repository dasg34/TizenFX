...
public abstract class ObjectWrapper : IWrapper, IDisposable
{
    ...
    {
        return (IntPtr data, ref CoreUI.Event.NativeStruct evt) =>
        {
    ...
    private static void OwnershipUniqueCallback(IntPtr data, ref CoreUI.Event.NativeStruct evt)
    {
        var ws = CoreUI.Wrapper.Globals.WrapperSupervisorPtrToManaged(data);
        ws.MakeUnique();
    }

    private static void OwnershipSharedCallback(IntPtr data, ref CoreUI.Event.NativeStruct evt)
    {
        var ws = CoreUI.Wrapper.Globals.WrapperSupervisorPtrToManaged(data);
        ws.MakeShared();
    }
