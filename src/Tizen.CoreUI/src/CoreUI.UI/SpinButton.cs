...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class SpinButtonExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Wraparound<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.SpinButton, T>magic = null) where T : CoreUI.UI.SpinButton {
        return new CoreUI.BindableProperty<bool>("wraparound", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation> Orientation<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.SpinButton, T>magic = null) where T : CoreUI.UI.SpinButton {
        return new CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation>("orientation", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> RangeStep<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.SpinButton, T>magic = null) where T : CoreUI.UI.SpinButton {
