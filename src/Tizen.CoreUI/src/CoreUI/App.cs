...
public abstract class App : CoreUI.Loop
{
    ...
    /// <summary>Method to raise event StandbyEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnStandbyEvent()
    {
    ...
    /// <summary>Method to raise event TerminateEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnTerminateEvent()
    {
    ...
    /// <summary>Method to raise event SignalUsr1Event.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnSignalUsr1Event()
    {
    ...
    /// <summary>Method to raise event SignalUsr2Event.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnSignalUsr2Event()
    {
    ...
    /// <summary>Method to raise event SignalHupEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnSignalHupEvent()
    {
