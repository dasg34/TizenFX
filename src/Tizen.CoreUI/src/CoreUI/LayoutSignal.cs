...
/// <since_tizen> 6 </since_tizen>
[CoreUI.Layout.SignalConcrete.NativeMethods]
[CoreUI.Wrapper.BindingEntity]
    ...
    ISignal
{
    ...
    private SignalConcrete(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    /// <param name="id">A identification number for the message to be sent</param>
    /// <param name="msg">The message&apos;s payload</param>
    public void SendMessage(int id, CoreUI.DataTypes.Value msg) {
        CoreUI.Layout.SignalConcrete.NativeMethods.efl_layout_signal_message_send_ptr.Value.Delegate(this.NativeHandle, id, msg);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <param name="func">The callback function to be executed when the signal is emitted.</param>
    /// <returns><c>true</c> in case of success, <c>false</c> in case of error.</returns>
    public bool AddSignalCallback(System.String emission, System.String source, CoreUILayoutSignalCb func) {
        GCHandle func_handle = GCHandle.Alloc(func);
var _ret_var = CoreUI.Layout.SignalConcrete.NativeMethods.efl_layout_signal_callback_add_ptr.Value.Delegate(this.NativeHandle, emission, source, GCHandle.ToIntPtr(func_handle), CoreUILayoutSignalCbWrapper.Cb, CoreUI.Wrapper.Globals.free_gchandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <param name="func">The callback function to be executed when the signal is emitted.</param>
    /// <returns><c>true</c> in case of success, <c>false</c> in case of error.</returns>
    public bool DelSignalCallback(System.String emission, System.String source, CoreUILayoutSignalCb func) {
        GCHandle func_handle = GCHandle.Alloc(func);
var _ret_var = CoreUI.Layout.SignalConcrete.NativeMethods.efl_layout_signal_callback_del_ptr.Value.Delegate(this.NativeHandle, emission, source, GCHandle.ToIntPtr(func_handle), CoreUILayoutSignalCbWrapper.Cb, CoreUI.Wrapper.Globals.free_gchandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void EmitSignal(System.String emission, System.String source) {
        CoreUI.Layout.SignalConcrete.NativeMethods.efl_layout_signal_emit_ptr.Value.Delegate(this.NativeHandle, emission, source);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void ProcessSignal(bool recurse) {
        CoreUI.Layout.SignalConcrete.NativeMethods.efl_layout_signal_process_ptr.Value.Delegate(this.NativeHandle, recurse);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning restore CS0628
    ...
    {
        return CoreUI.Layout.SignalConcrete.efl_layout_signal_interface_get();
    }
