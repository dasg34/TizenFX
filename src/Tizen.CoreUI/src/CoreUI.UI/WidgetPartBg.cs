...
/// 
/// This part will proxy the calls on it to the <see cref="CoreUI.UI.Bg"/> internal object of this widget. This internal object is stacked below the <see cref="CoreUI.UI.Widget.SetResizeObject"/> and co-located with the widget.
/// 
/// All <see cref="CoreUI.UI.Widget"/> objects have this part, allowing the background of the widget to be customized.</summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.UI.WidgetPartBg.NativeMethods]
[CoreUI.Wrapper.BindingEntity]
[SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
public class WidgetPartBg : CoreUI.UI.WidgetPart, CoreUI.IFile, CoreUI.Gfx.IColor, CoreUI.Gfx.IImage
{
    ...
    /// <since_tizen> 6 </since_tizen>
    public WidgetPartBg(CoreUI.Object parent= null) : base(efl_ui_widget_part_bg_class_get(), parent)
    {
        FinishInstantiation();
    }
    ...
    internal WidgetPartBg(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
    ...
    protected WidgetPartBg(IntPtr baseKlass, CoreUI.Object parent) : base(baseKlass, parent)
    {
    }
...
var _ret_var = CoreUI.Gfx.ImageConcrete.NativeMethods.efl_gfx_image_stretch_region_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_horizontal, _in_vertical);
    ...
    {
        return CoreUI.UI.WidgetPartBg.efl_ui_widget_part_bg_class_get();
    }
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class WidgetPartBgExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.File> Mmap<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.File>("mmap", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> File<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
        return new CoreUI.BindableProperty<System.String>("file", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Key<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
        return new CoreUI.BindableProperty<System.String>("key", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> ColorCode<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
        return new CoreUI.BindableProperty<System.String>("color_code", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> SmoothScale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
        return new CoreUI.BindableProperty<bool>("smooth_scale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleMethod> ScaleMethod<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
        return new CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleMethod>("scale_method", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> CanUpscale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
        return new CoreUI.BindableProperty<bool>("can_upscale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> CanDownscale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
        return new CoreUI.BindableProperty<bool>("can_downscale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> BorderInsetsScale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
        return new CoreUI.BindableProperty<double>("border_insets_scale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.CenterFillMode> CenterFillMode<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
        return new CoreUI.BindableProperty<CoreUI.Gfx.CenterFillMode>("center_fill_mode", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.ImageContentHint> ContentHint<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
        return new CoreUI.BindableProperty<CoreUI.Gfx.ImageContentHint>("content_hint", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleHint> ScaleHint<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.WidgetPartBg, T>magic = null) where T : CoreUI.UI.WidgetPartBg {
