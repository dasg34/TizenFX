...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class CompositeModelExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<uint> Index<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.CompositeModel, T>magic = null) where T : CoreUI.CompositeModel {
        return new CoreUI.BindableProperty<uint>("index", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.IModel> Model<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.CompositeModel, T>magic = null) where T : CoreUI.CompositeModel {
