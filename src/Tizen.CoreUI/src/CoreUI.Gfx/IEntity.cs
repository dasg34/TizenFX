...
[CoreUI.Gfx.EntityConcrete.NativeMethods]
    ...
    CoreUI.Wrapper.IWrapper, IDisposable
{
    ...
    event EventHandler<CoreUI.Gfx.EntityVisibilityChangedEventArgs> VisibilityChangedEvent;
    ...
    event EventHandler<CoreUI.Gfx.EntityPositionChangedEventArgs> PositionChangedEvent;
    ...
    event EventHandler<CoreUI.Gfx.EntitySizeChangedEventArgs> SizeChangedEvent;
    /// <summary>The 2D position of a canvas object.
    /// 
    /// The position is absolute, in pixels, relative to the top-left corner of the window, within its border decorations (application space).<br/>
...
/// <summary>Event argument wrapper for event <see cref="CoreUI.Gfx.IEntity.VisibilityChangedEvent"/>.
/// </summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.Wrapper.BindingEntity]
...
/// <summary>Event argument wrapper for event <see cref="CoreUI.Gfx.IEntity.PositionChangedEvent"/>.
/// </summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.Wrapper.BindingEntity]
...
/// <summary>Event argument wrapper for event <see cref="CoreUI.Gfx.IEntity.SizeChangedEvent"/>.
/// </summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.Wrapper.BindingEntity]
    ...
    IEntity
{
    ...
    /// <since_tizen> 6 </since_tizen>
    public void OnVisibilityChangedEvent(CoreUI.Gfx.EntityVisibilityChangedEventArgs e)
    {
        IntPtr info = CoreUI.DataTypes.PrimitiveConversion.ManagedToPointerAlloc(e.arg ? (byte) 1 : (byte) 0);
        CallNativeEventCallback(CoreUI.Libs.CoreUI, "_EFL_GFX_ENTITY_EVENT_VISIBILITY_CHANGED", info, (p) => Marshal.FreeHGlobal(p));
    }
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    public void OnPositionChangedEvent(CoreUI.Gfx.EntityPositionChangedEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
        CallNativeEventCallback(CoreUI.Libs.CoreUI, "_EFL_GFX_ENTITY_EVENT_POSITION_CHANGED", info, (p) => Marshal.FreeHGlobal(p));
    }
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    public void OnSizeChangedEvent(CoreUI.Gfx.EntitySizeChangedEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
        CallNativeEventCallback(CoreUI.Libs.CoreUI, "_EFL_GFX_ENTITY_EVENT_SIZE_CHANGED", info, (p) => Marshal.FreeHGlobal(p));
    }
...
#pragma warning disable CS0628
    ...
    /// <returns>A 2D coordinate in pixel units.</returns>
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.DataTypes.Position2D GetPosition() {
        var _ret_var = CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_position_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    /// <param name="pos">A 2D coordinate in pixel units.</param>
    /// <since_tizen> 6 </since_tizen>
    public void SetPosition(CoreUI.DataTypes.Position2D pos) {
        CoreUI.DataTypes.Position2D.NativeStruct _in_pos = pos;
CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_position_set_ptr.Value.Delegate(this.NativeHandle, _in_pos);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <returns>A 2D size in pixel units.</returns>
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.DataTypes.Size2D GetSize() {
        var _ret_var = CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_size_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <param name="size">A 2D size in pixel units.</param>
    /// <since_tizen> 6 </since_tizen>
    public void SetSize(CoreUI.DataTypes.Size2D size) {
        CoreUI.DataTypes.Size2D.NativeStruct _in_size = size;
CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_size_set_ptr.Value.Delegate(this.NativeHandle, _in_size);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <returns>The X,Y position and W,H size, in pixels.</returns>
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.DataTypes.Rect GetGeometry() {
        var _ret_var = CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_geometry_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// <param name="rect">The X,Y position and W,H size, in pixels.</param>
    /// <since_tizen> 6 </since_tizen>
    public void SetGeometry(CoreUI.DataTypes.Rect rect) {
        CoreUI.DataTypes.Rect.NativeStruct _in_rect = rect;
CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_geometry_set_ptr.Value.Delegate(this.NativeHandle, _in_rect);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public bool GetVisible() {
        var _ret_var = CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_visible_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetVisible(bool v) {
        CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_visible_set_ptr.Value.Delegate(this.NativeHandle, v);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public double GetScale() {
        var _ret_var = CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_scale_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetScale(double scale) {
        CoreUI.Gfx.EntityConcrete.NativeMethods.efl_gfx_entity_scale_set_ptr.Value.Delegate(this.NativeHandle, scale);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning restore CS0628
    ...
    {
        return CoreUI.Gfx.EntityConcrete.efl_gfx_entity_interface_get();
    }
    ...
    /// </summary>
        ...
        private delegate CoreUI.DataTypes.Position2D.NativeStruct efl_gfx_entity_position_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Position2D.NativeStruct efl_gfx_entity_position_get_api_delegate(System.IntPtr obj);
        ...
        private delegate void efl_gfx_entity_position_set_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Position2D.NativeStruct pos);

        
        internal delegate void efl_gfx_entity_position_set_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Position2D.NativeStruct pos);
        ...
        private delegate CoreUI.DataTypes.Size2D.NativeStruct efl_gfx_entity_size_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Size2D.NativeStruct efl_gfx_entity_size_get_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Size2D.NativeStruct size_get(System.IntPtr obj, System.IntPtr pd)
        {
        ...
        private delegate void efl_gfx_entity_size_set_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Size2D.NativeStruct size);

        
        internal delegate void efl_gfx_entity_size_set_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Size2D.NativeStruct size);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static void size_set(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Size2D.NativeStruct size)
        {
        ...
        private delegate CoreUI.DataTypes.Rect.NativeStruct efl_gfx_entity_geometry_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Rect.NativeStruct efl_gfx_entity_geometry_get_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Rect.NativeStruct geometry_get(System.IntPtr obj, System.IntPtr pd)
        {
        ...
        private delegate void efl_gfx_entity_geometry_set_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Rect.NativeStruct rect);

        
        internal delegate void efl_gfx_entity_geometry_set_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Rect.NativeStruct rect);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static void geometry_set(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Rect.NativeStruct rect)
        {
...
public static class EntityConcreteExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Position2D> Position<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Gfx.IEntity, T>magic = null) where T : CoreUI.Gfx.IEntity {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Position2D>("position", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Size2D> Size<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Gfx.IEntity, T>magic = null) where T : CoreUI.Gfx.IEntity {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Size2D>("size", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Rect> Geometry<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Gfx.IEntity, T>magic = null) where T : CoreUI.Gfx.IEntity {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Rect>("geometry", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Visible<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Gfx.IEntity, T>magic = null) where T : CoreUI.Gfx.IEntity {
        return new CoreUI.BindableProperty<bool>("visible", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> Scale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Gfx.IEntity, T>magic = null) where T : CoreUI.Gfx.IEntity {
