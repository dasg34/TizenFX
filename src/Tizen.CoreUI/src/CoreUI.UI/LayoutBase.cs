...
var _ret_var = CoreUI.Layout.SignalConcrete.NativeMethods.efl_layout_signal_callback_del_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), emission, source, GCHandle.ToIntPtr(func_handle), CoreUILayoutSignalCbWrapper.Cb, CoreUI.Wrapper.Globals.free_gchandle);
    ...
    public virtual CoreUI.DataTypes.Error BindFactory(System.String key, CoreUI.UI.IFactory factory) {
        var _ret_var = CoreUI.UI.FactoryBindConcrete.NativeMethods.efl_ui_factory_bind_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), key, factory);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class LayoutBaseExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> CalcAutoUpdateHints<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.LayoutBase, T>magic = null) where T : CoreUI.UI.LayoutBase {
