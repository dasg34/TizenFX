...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class PopupPartBackwallExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> RepeatEvents<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.PopupPartBackwall, T>magic = null) where T : CoreUI.UI.PopupPartBackwall {
    ...
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.File> Mmap<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.PopupPartBackwall, T>magic = null) where T : CoreUI.UI.PopupPartBackwall {
    ...
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> File<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.PopupPartBackwall, T>magic = null) where T : CoreUI.UI.PopupPartBackwall {
    ...
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Key<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.PopupPartBackwall, T>magic = null) where T : CoreUI.UI.PopupPartBackwall {
