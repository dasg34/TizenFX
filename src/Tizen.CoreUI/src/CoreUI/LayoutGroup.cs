...
[CoreUI.Layout.GroupConcrete.NativeMethods]
    ...
    IGroup
{
    ...
    private GroupConcrete(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    /// <returns>The minimum size as set in EDC.</returns>
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.DataTypes.Size2D GetGroupSizeMin() {
        var _ret_var = CoreUI.Layout.GroupConcrete.NativeMethods.efl_layout_group_size_min_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    /// <returns>The maximum size as set in EDC.</returns>
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.DataTypes.Size2D GetGroupSizeMax() {
        var _ret_var = CoreUI.Layout.GroupConcrete.NativeMethods.efl_layout_group_size_max_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public System.String GetGroupData(System.String key) {
        var _ret_var = CoreUI.Layout.GroupConcrete.NativeMethods.efl_layout_group_data_get_ptr.Value.Delegate(this.NativeHandle, key);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public bool GetPartExist(System.String part) {
        var _ret_var = CoreUI.Layout.GroupConcrete.NativeMethods.efl_layout_group_part_exist_get_ptr.Value.Delegate(this.NativeHandle, part);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
#pragma warning restore CS0628
    ...
    {
        return CoreUI.Layout.GroupConcrete.efl_layout_group_interface_get();
    }
    ...
    /// </summary>
        ...
        private delegate CoreUI.DataTypes.Size2D.NativeStruct efl_layout_group_size_min_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Size2D.NativeStruct efl_layout_group_size_min_get_api_delegate(System.IntPtr obj);
        ...
        private static CoreUI.DataTypes.Size2D.NativeStruct group_size_min_get(System.IntPtr obj, System.IntPtr pd)
        {
        ...
        private delegate CoreUI.DataTypes.Size2D.NativeStruct efl_layout_group_size_max_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Size2D.NativeStruct efl_layout_group_size_max_get_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Size2D.NativeStruct group_size_max_get(System.IntPtr obj, System.IntPtr pd)
        {
