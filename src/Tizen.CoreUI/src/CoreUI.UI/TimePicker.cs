...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    ...
    /// <summary>Method to raise event TimeChangedEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnTimeChangedEvent()
    {
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class TimePickerExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Is24hour<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.TimePicker, T>magic = null) where T : CoreUI.UI.TimePicker {
        return new CoreUI.BindableProperty<bool>("is_24hour", fac);
    }
