...
/// <summary>Event argument wrapper for event <see cref="CoreUI.Canvas.Group.MemberAddedEvent"/>.
/// </summary>
...
/// <summary>Event argument wrapper for event <see cref="CoreUI.Canvas.Group.MemberRemovedEvent"/>.
/// </summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.Wrapper.BindingEntity]
...
public class Group : CoreUI.Canvas.Object
{
    ...
    public event EventHandler<CoreUI.Canvas.GroupMemberAddedEventArgs> MemberAddedEvent
    {
        add
        {
            CoreUI.EventCb callerCb = GetInternalEventCallback(value, info => new CoreUI.Canvas.GroupMemberAddedEventArgs{ arg = (CoreUI.Wrapper.Globals.CreateWrapperFor(info) as CoreUI.Gfx.EntityConcrete) });
    ...
    /// <summary>Method to raise event MemberAddedEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnMemberAddedEvent(CoreUI.Canvas.GroupMemberAddedEventArgs e)
    {
...
CallNativeEventCallback(CoreUI.Libs.Evas, "_EFL_CANVAS_GROUP_EVENT_MEMBER_ADDED", info, null);
    ...
    public event EventHandler<CoreUI.Canvas.GroupMemberRemovedEventArgs> MemberRemovedEvent
    {
        add
        {
            CoreUI.EventCb callerCb = GetInternalEventCallback(value, info => new CoreUI.Canvas.GroupMemberRemovedEventArgs{ arg = (CoreUI.Wrapper.Globals.CreateWrapperFor(info) as CoreUI.Gfx.EntityConcrete) });
    ...
    /// <summary>Method to raise event MemberRemovedEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnMemberRemovedEvent(CoreUI.Canvas.GroupMemberRemovedEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
...
public static class GroupExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> GroupNeedRecalculate<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Canvas.Group, T>magic = null) where T : CoreUI.Canvas.Group {
        return new CoreUI.BindableProperty<bool>("group_need_recalculate", fac);
    }
