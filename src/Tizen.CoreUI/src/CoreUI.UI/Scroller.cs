...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class ScrollerExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Scroller, T>magic = null) where T : CoreUI.UI.Scroller {
        return new CoreUI.BindableProperty<CoreUI.Gfx.IEntity>("content", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Position2D> ContentPos<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Scroller, T>magic = null) where T : CoreUI.UI.Scroller {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Position2D>("content_pos", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> ScrollFreeze<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Scroller, T>magic = null) where T : CoreUI.UI.Scroller {
        return new CoreUI.BindableProperty<bool>("scroll_freeze", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> ScrollHold<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Scroller, T>magic = null) where T : CoreUI.UI.Scroller {
        return new CoreUI.BindableProperty<bool>("scroll_hold", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation> MovementBlock<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Scroller, T>magic = null) where T : CoreUI.UI.Scroller {
        return new CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation>("movement_block", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Position2D> StepSize<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Scroller, T>magic = null) where T : CoreUI.UI.Scroller {
