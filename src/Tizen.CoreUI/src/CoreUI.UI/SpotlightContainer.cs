...
/// <summary>Event argument wrapper for event <see cref="CoreUI.UI.Spotlight.Container.TransitionStartEvent"/>.
/// </summary>
...
public class ContainerTransitionStartEventArgs : EventArgs {
    ...
    /// <since_tizen> 6 </since_tizen>
    public CoreUI.UI.Spotlight.TransitionEvent arg { get; set; }
}

/// <summary>Event argument wrapper for event <see cref="CoreUI.UI.Spotlight.Container.TransitionEndEvent"/>.
/// </summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.Wrapper.BindingEntity]
...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <value><see cref="CoreUI.UI.Spotlight.ContainerTransitionStartEventArgs"/></value>
    public event EventHandler<CoreUI.UI.Spotlight.ContainerTransitionStartEventArgs> TransitionStartEvent
    {
        add
        {
            CoreUI.EventCb callerCb = GetInternalEventCallback(value, info => new CoreUI.UI.Spotlight.ContainerTransitionStartEventArgs{ arg =  info });
    ...
    /// <summary>Method to raise event TransitionStartEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnTransitionStartEvent(CoreUI.UI.Spotlight.ContainerTransitionStartEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
        CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_UI_SPOTLIGHT_EVENT_TRANSITION_START", info, (p) => Marshal.FreeHGlobal(p));
    }

    /// <summary>A transition animation has ended.</summary>
    /// <since_tizen> 6 </since_tizen>
    /// <value><see cref="CoreUI.UI.Spotlight.ContainerTransitionEndEventArgs"/></value>
    public event EventHandler<CoreUI.UI.Spotlight.ContainerTransitionEndEventArgs> TransitionEndEvent
    {
        add
        {
            CoreUI.EventCb callerCb = GetInternalEventCallback(value, info => new CoreUI.UI.Spotlight.ContainerTransitionEndEventArgs{ arg =  info });
    ...
    /// <summary>Method to raise event TransitionEndEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnTransitionEndEvent(CoreUI.UI.Spotlight.ContainerTransitionEndEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
        CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_UI_SPOTLIGHT_EVENT_TRANSITION_END", info, (p) => Marshal.FreeHGlobal(p));
    }
...
CoreUI.UI.Spotlight.Container.NativeMethods.efl_ui_spotlight_size_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_size);
    ...
    /// </summary>
        ...
        private delegate CoreUI.DataTypes.Size2D.NativeStruct efl_ui_spotlight_size_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Size2D.NativeStruct efl_ui_spotlight_size_get_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Size2D.NativeStruct spotlight_size_get(System.IntPtr obj, System.IntPtr pd)
        {
        ...
        private delegate void efl_ui_spotlight_size_set_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Size2D.NativeStruct size);

        
        internal delegate void efl_ui_spotlight_size_set_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Size2D.NativeStruct size);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static void spotlight_size_set(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Size2D.NativeStruct size)
        {
...
public static class ContainerExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.Widget> ActiveElement<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Spotlight.Container, T>magic = null) where T : CoreUI.UI.Spotlight.Container {
        return new CoreUI.BindableProperty<CoreUI.UI.Widget>("active_element", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Size2D> SpotlightSize<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Spotlight.Container, T>magic = null) where T : CoreUI.UI.Spotlight.Container {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Size2D>("spotlight_size", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> AnimatedTransition<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Spotlight.Container, T>magic = null) where T : CoreUI.UI.Spotlight.Container {
        return new CoreUI.BindableProperty<bool>("animated_transition", fac);
    }
...
public struct TransitionEvent : IEquatable<TransitionEvent>
{
    ...
    /// <since_tizen> 6 </since_tizen>
    public int To;
    /// <summary>Constructor for TransitionEvent.
    /// </summary>
    ...
    /// <summary>Packs tuple into TransitionEvent object.
    ///<para>Since EFL 1.24.</para>
    ///</summary>
    public static implicit operator TransitionEvent(
        (
         int From,
         int To
        ) tuple)
    ...
    /// <summary>Unpacks TransitionEvent into tuple.
    /// <para>Since EFL 1.24.</para>
    /// </summary>
    ...
    public override bool Equals(object other)
        => ((other is TransitionEvent) ? Equals((TransitionEvent)other) : false);
    /// <summary>Equality comparison.
    /// </summary>
    public static bool operator ==(TransitionEvent lhs, TransitionEvent rhs)
    ...
    /// </summary>
    /// <param name="ptr">Native pointer to be converted.</param>
    public static TransitionEvent FromIntPtr(IntPtr ptr)
    {
        return ptr;
    }
