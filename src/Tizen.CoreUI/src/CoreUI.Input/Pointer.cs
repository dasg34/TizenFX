...
CoreUI.Input.Pointer.NativeMethods.efl_input_pointer_position_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_pos);
    ...
    public virtual void SetPrecisePosition(CoreUI.DataTypes.Vector2 pos) {
        CoreUI.DataTypes.Vector2.NativeStruct _in_pos = pos;
...
CoreUI.Input.Pointer.NativeMethods.efl_input_pointer_previous_position_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_pos);
    ...
    public virtual double GetTimestamp() {
        var _ret_var = CoreUI.Input.EventConcrete.NativeMethods.efl_input_timestamp_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetTimestamp(double ms) {
        CoreUI.Input.EventConcrete.NativeMethods.efl_input_timestamp_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), ms);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.Input.Device GetDevice() {
        var _ret_var = CoreUI.Input.EventConcrete.NativeMethods.efl_input_device_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetDevice(CoreUI.Input.Device dev) {
        CoreUI.Input.EventConcrete.NativeMethods.efl_input_device_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), dev);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.Input.Flags GetEventFlags() {
        var _ret_var = CoreUI.Input.EventConcrete.NativeMethods.efl_input_event_flags_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetEventFlags(CoreUI.Input.Flags flags) {
        CoreUI.Input.EventConcrete.NativeMethods.efl_input_event_flags_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), flags);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetProcessed() {
        var _ret_var = CoreUI.Input.EventConcrete.NativeMethods.efl_input_processed_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetProcessed(bool val) {
        CoreUI.Input.EventConcrete.NativeMethods.efl_input_processed_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), val);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetScrolling() {
        var _ret_var = CoreUI.Input.EventConcrete.NativeMethods.efl_input_scrolling_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetScrolling(bool val) {
        CoreUI.Input.EventConcrete.NativeMethods.efl_input_scrolling_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), val);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual bool GetFake() {
        var _ret_var = CoreUI.Input.EventConcrete.NativeMethods.efl_input_fake_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void Reset() {
        CoreUI.Input.EventConcrete.NativeMethods.efl_input_reset_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// </summary>
        ...
        private delegate CoreUI.DataTypes.Position2D.NativeStruct efl_input_pointer_position_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Position2D.NativeStruct efl_input_pointer_position_get_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Position2D.NativeStruct position_get(System.IntPtr obj, System.IntPtr pd)
        {
        ...
        private delegate void efl_input_pointer_position_set_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Position2D.NativeStruct pos);

        
        internal delegate void efl_input_pointer_position_set_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Position2D.NativeStruct pos);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static void position_set(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Position2D.NativeStruct pos)
        {
        ...
        private delegate CoreUI.DataTypes.Vector2.NativeStruct efl_input_pointer_precise_position_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Vector2.NativeStruct efl_input_pointer_precise_position_get_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Vector2.NativeStruct precise_position_get(System.IntPtr obj, System.IntPtr pd)
        {
        ...
        private delegate void efl_input_pointer_precise_position_set_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Vector2.NativeStruct pos);

        
        internal delegate void efl_input_pointer_precise_position_set_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Vector2.NativeStruct pos);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static void precise_position_set(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Vector2.NativeStruct pos)
        {
        ...
        private delegate CoreUI.DataTypes.Position2D.NativeStruct efl_input_pointer_previous_position_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Position2D.NativeStruct efl_input_pointer_previous_position_get_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Position2D.NativeStruct previous_position_get(System.IntPtr obj, System.IntPtr pd)
        {
        ...
        private delegate void efl_input_pointer_previous_position_set_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Position2D.NativeStruct pos);

        
        internal delegate void efl_input_pointer_previous_position_set_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Position2D.NativeStruct pos);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static void previous_position_set(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Position2D.NativeStruct pos)
        {
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class PointerExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Pointer.Action> Action<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<CoreUI.Pointer.Action>("action", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<int> Button<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<int>("button", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Position2D> Position<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Position2D>("position", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Vector2> PrecisePosition<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Vector2>("precise_position", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Position2D> PreviousPosition<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Position2D>("previous_position", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<int> TouchId<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<int>("touch_id", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Object> Source<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<CoreUI.Object>("source", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Pointer.Flags> ButtonFlags<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<CoreUI.Pointer.Flags>("button_flags", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> DoubleClick<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<bool>("double_click", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> TripleClick<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<bool>("triple_click", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> WheelHorizontal<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<bool>("wheel_horizontal", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<int> WheelDelta<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<int>("wheel_delta", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> Timestamp<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<double>("timestamp", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Input.Device> Device<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<CoreUI.Input.Device>("device", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Input.Flags> EventFlags<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<CoreUI.Input.Flags>("event_flags", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Processed<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<bool>("processed", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Scrolling<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Pointer, T>magic = null) where T : CoreUI.Input.Pointer {
        return new CoreUI.BindableProperty<bool>("scrolling", fac);
    }
