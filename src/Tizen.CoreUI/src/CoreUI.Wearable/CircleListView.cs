...
namespace CoreUI
{
    ...
    {
        /// <summary>
        /// The CircleListView is a widget to display and handle the genlist items by the rotary event.
        /// </summary>
        /// <since_tizen> 6 </since_tizen>
        public class CircleListView : CoreUI.UI.ListView, ICircleWidget
        {
            IntPtr _handle;
            ...
            /// <summary>
            /// Creates and initializes a new instance of the CircleListView class.
            /// </summary>
            /// <param name="parent">The CoreUI.UI.Widget to which the new CircleListView will be attached as a child.</param>
            /// <since_tizen> 6 </since_tizen>
            public CircleListView(CoreUI.Object parent) : base(parent)
            {
                ...
                this.PositionManager = new PositionManager.CircleList();
                this.ScrollDestinationFinalizedEvent += (object sender, CoreUI.UI.ScrollableScrollDestinationFinalizedEventArgs e) =>
                {
                    CoreUI.DataTypes.Position2D vPos, dst;
                    CoreUI.DataTypes.Rect iPos, view;
                    CoreUI.Wearable.CircleListView list = sender as CircleListView;
                    ...
                    dst.Y += (view.H / 2);
                    int idx = ((PositionManager.CircleList) list.PositionManager).GetPositionedItem(dst);
                    iPos = list.PositionManager.PositionSingleItem(idx);
                    iPos.Y = iPos.Y + vPos.Y - view.Y - ((view.H - iPos.H) / 2);
                    iPos.H = view.H;
                    list.Scroll(iPos, true);
                };
            }
