...
public abstract class Task : CoreUI.LoopConsumer
{
    ...
    /// <summary>Method to raise event ExitEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
...
public static class TaskExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.TaskPriority> Priority<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Task, T>magic = null) where T : CoreUI.Task {
        return new CoreUI.BindableProperty<CoreUI.TaskPriority>("priority", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.TaskFlags> Flags<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Task, T>magic = null) where T : CoreUI.Task {
        return new CoreUI.BindableProperty<CoreUI.TaskFlags>("flags", fac);
    }
...
/// <summary>Flags to further customize task&apos;s behavior.</summary>
/// <since_tizen> 6 </since_tizen>
[Flags][CoreUI.Wrapper.BindingEntity]
