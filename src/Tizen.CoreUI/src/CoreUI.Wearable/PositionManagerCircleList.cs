...
public class CircleList : CoreUI.Object, CoreUI.UI.ILayoutOrientable, CoreUI.UI.PositionManager.IDataAccessV1, CoreUI.UI.PositionManager.IEntity
{
    ...
    protected virtual void OnContentSizeChangedEvent(CoreUI.UI.PositionManager.EntityContentSizeChangedEventArgs e)
    {
    ...
    /// </summary>
    /// <param name="e">Event to raise.</param>
    protected virtual void OnContentMinSizeChangedEvent(CoreUI.UI.PositionManager.EntityContentMinSizeChangedEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
    ...
    /// </summary>
    /// <param name="e">Event to raise.</param>
    protected virtual void OnVisibleRangeChangedEvent(CoreUI.UI.PositionManager.EntityVisibleRangeChangedEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
...
CoreUI.UI.PositionManager.EntityConcrete.NativeMethods.efl_ui_position_manager_entity_viewport_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_viewport);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void SetScrollPosition(double x, double y) {
        CoreUI.UI.PositionManager.EntityConcrete.NativeMethods.efl_ui_position_manager_entity_scroll_position_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), x, y);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual int Version(int max) {
        var _ret_var = CoreUI.UI.PositionManager.EntityConcrete.NativeMethods.efl_ui_position_manager_entity_version_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), max);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Rect PositionSingleItem(int idx) {
        var _ret_var = CoreUI.UI.PositionManager.EntityConcrete.NativeMethods.efl_ui_position_manager_entity_position_single_item_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), idx);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void ItemAdded(int added_index, CoreUI.Gfx.IEntity subobj) {
        CoreUI.UI.PositionManager.EntityConcrete.NativeMethods.efl_ui_position_manager_entity_item_added_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), added_index, subobj);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void ItemRemoved(int removed_index, CoreUI.Gfx.IEntity subobj) {
        CoreUI.UI.PositionManager.EntityConcrete.NativeMethods.efl_ui_position_manager_entity_item_removed_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), removed_index, subobj);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void ItemSizeChanged(int start_id, int end_id) {
        CoreUI.UI.PositionManager.EntityConcrete.NativeMethods.efl_ui_position_manager_entity_item_size_changed_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), start_id, end_id);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual void EntitiesReady(uint start_id, uint end_id) {
        CoreUI.UI.PositionManager.EntityConcrete.NativeMethods.efl_ui_position_manager_entity_entities_ready_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), start_id, end_id);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual int RelativeItem(uint current_id, CoreUI.UI.Focus.Direction direction) {
        var _ret_var = CoreUI.UI.PositionManager.EntityConcrete.NativeMethods.efl_ui_position_manager_entity_relative_item_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), current_id, direction);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// </summary>
        ...
        private delegate int efl_wearable_position_manager_circle_list_positioned_item_get_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Position2D.NativeStruct pos);

        
        internal delegate int efl_wearable_position_manager_circle_list_positioned_item_get_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Position2D.NativeStruct pos);
        ...
        private static int positioned_item_get(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Position2D.NativeStruct pos)
        {
...
#pragma warning disable CS1591
public static class CoreUI_Wearable_Position_ManagerCircleList_ExtensionMethods {
}
