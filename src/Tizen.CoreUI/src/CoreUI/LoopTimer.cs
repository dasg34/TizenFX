...
/// <param name="timerInterval">Interval the timer ticks on. See <see cref="CoreUI.LoopTimer.SetTimerInterval" /></param>
    ...
    /// <summary>Method to raise event TimerTickEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnTimerTickEvent()
    {
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class LoopTimerExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> TimerInterval<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.LoopTimer, T>magic = null) where T : CoreUI.LoopTimer {
        return new CoreUI.BindableProperty<double>("timer_interval", fac);
    }
