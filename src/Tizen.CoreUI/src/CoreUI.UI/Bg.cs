...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class BgExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.File> Mmap<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.File>("mmap", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> File<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<System.String>("file", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Key<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<System.String>("key", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> SmoothScale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<bool>("smooth_scale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleMethod> ScaleMethod<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleMethod>("scale_method", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> CanUpscale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<bool>("can_upscale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> CanDownscale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<bool>("can_downscale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> BorderInsetsScale<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<double>("border_insets_scale", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.CenterFillMode> CenterFillMode<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<CoreUI.Gfx.CenterFillMode>("center_fill_mode", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.ImageContentHint> ContentHint<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<CoreUI.Gfx.ImageContentHint>("content_hint", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleHint> ScaleHint<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<CoreUI.Gfx.ImageScaleHint>("scale_hint", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Size2D> LoadSize<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Size2D>("load_size", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> LoadDpi<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<double>("load_dpi", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Rect> LoadRegion<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Rect>("load_region", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> LoadOrientation<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<bool>("load_orientation", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<int> LoadScaleDown<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
        return new CoreUI.BindableProperty<int>("load_scale_down", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> LoadSkipHeader<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Bg, T>magic = null) where T : CoreUI.UI.Bg {
