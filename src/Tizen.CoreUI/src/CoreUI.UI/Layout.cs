...
public static class LayoutExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.File> Mmap<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Layout, T>magic = null) where T : CoreUI.UI.Layout {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.File>("mmap", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> File<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Layout, T>magic = null) where T : CoreUI.UI.Layout {
        return new CoreUI.BindableProperty<System.String>("file", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Key<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Layout, T>magic = null) where T : CoreUI.UI.Layout {
