...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    ...
    /// <since_tizen> 6 </since_tizen>
    public event EventHandler SliderDragStartEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event SliderDragStartEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnSliderDragStartEvent()
    {
    ...
    /// <since_tizen> 6 </since_tizen>
    public event EventHandler SliderDragStopEvent
    {
        add
        {
            CoreUI.EventCb callerCb = GetInternalEventCallback(value);
    ...
    /// <summary>Method to raise event SliderDragStopEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnSliderDragStopEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnSteadyEvent()
    {
    ...
    public virtual double GetRangeStep() {
        var _ret_var = CoreUI.UI.RangeInteractiveConcrete.NativeMethods.efl_ui_range_step_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetRangeStep(double step) {
        CoreUI.UI.RangeInteractiveConcrete.NativeMethods.efl_ui_range_step_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), step);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class SliderExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation> Orientation<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Slider, T>magic = null) where T : CoreUI.UI.Slider {
        return new CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation>("orientation", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> RangeValue<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Slider, T>magic = null) where T : CoreUI.UI.Slider {
        return new CoreUI.BindableProperty<double>("range_value", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> RangeStep<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Slider, T>magic = null) where T : CoreUI.UI.Slider {
