...
/// 
/// The check widget allows for toggling a value between <c>true</c> and <c>false</c>. Check objects are a lot like <see cref="CoreUI.UI.Radio"/> objects in layout and functionality, except they do not work as a group, but independently, and only toggle the value of a boolean between <c>false</c> and <c>true</c>. The boolean value of the check can be retrieved using the <see cref="CoreUI.UI.ISelectable.Selected"/> property. Changes to <see cref="CoreUI.UI.ISelectable.Selected"/> can be listed to using the <see cref="CoreUI.UI.ISelectable.SelectedChangedEvent"/> event.</summary>
...
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_CONTENT_EVENT_CONTENT_CHANGED", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnSelectedChangedEvent(CoreUI.UI.SelectableSelectedChangedEventArgs e)
    {
    ...
    public virtual bool GetSelected() {
        var _ret_var = CoreUI.UI.SelectableConcrete.NativeMethods.efl_ui_selectable_selected_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetSelected(bool selected) {
        CoreUI.UI.SelectableConcrete.NativeMethods.efl_ui_selectable_selected_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), selected);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class CheckExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Check, T>magic = null) where T : CoreUI.UI.Check {
        return new CoreUI.BindableProperty<CoreUI.Gfx.IEntity>("content", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Text<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Check, T>magic = null) where T : CoreUI.UI.Check {
        return new CoreUI.BindableProperty<System.String>("text", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Selected<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Check, T>magic = null) where T : CoreUI.UI.Check {
