...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    ...
    /// <summary>Method to raise event BackwallClickedEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnBackwallClickedEvent()
    {
    ...
    /// <summary>Method to raise event TimeoutEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
...
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_CONTENT_EVENT_CONTENT_CHANGED", info, null);
    ...
    public virtual CoreUI.Canvas.Object GetScrollableContent() {
        var _ret_var = CoreUI.UI.WidgetScrollableContentConcrete.NativeMethods.efl_ui_widget_scrollable_content_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool SetScrollableContent(CoreUI.Canvas.Object content) {
        var _ret_var = CoreUI.UI.WidgetScrollableContentConcrete.NativeMethods.efl_ui_widget_scrollable_content_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), content);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }

    /// <summary>The text string to be displayed by the given text object. The text will use <span class="text-muted">CoreUI.TextFormatWrap.Mixed (object still in beta stage)</span> wrapping, and it will be scrollable depending on its size relative to the object&apos;s geometry.
    /// 
    /// When reading, do not free the return value.</summary>
    /// <returns>Text string to display on it.</returns>
    /// <since_tizen> 6 </since_tizen>
    public virtual System.String GetScrollableText() {
        var _ret_var = CoreUI.UI.WidgetScrollableContentConcrete.NativeMethods.efl_ui_widget_scrollable_text_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetScrollableText(System.String text) {
        CoreUI.UI.WidgetScrollableContentConcrete.NativeMethods.efl_ui_widget_scrollable_text_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), text);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class PopupExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.PopupAlign> Align<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Popup, T>magic = null) where T : CoreUI.UI.Popup {
        return new CoreUI.BindableProperty<CoreUI.UI.PopupAlign>("align", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<double> ClosingTimeout<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Popup, T>magic = null) where T : CoreUI.UI.Popup {
        return new CoreUI.BindableProperty<double>("closing_timeout", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Canvas.Object> Anchor<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Popup, T>magic = null) where T : CoreUI.UI.Popup {
        return new CoreUI.BindableProperty<CoreUI.Canvas.Object>("anchor", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Popup, T>magic = null) where T : CoreUI.UI.Popup {
        return new CoreUI.BindableProperty<CoreUI.Gfx.IEntity>("content", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Canvas.Object> ScrollableContent<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Popup, T>magic = null) where T : CoreUI.UI.Popup {
        return new CoreUI.BindableProperty<CoreUI.Canvas.Object>("scrollable_content", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> ScrollableText<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Popup, T>magic = null) where T : CoreUI.UI.Popup {
        return new CoreUI.BindableProperty<System.String>("scrollable_text", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindablePart<CoreUI.UI.PopupPartBackwall> BackwallPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Popup, T> x=null) where T : CoreUI.UI.Popup
    {
        return new CoreUI.BindablePart<CoreUI.UI.PopupPartBackwall>("backwall", fac);
    }
