...
[CoreUI.Gfx.MappingConcrete.NativeMethods]
    ...
    IMapping
{
    ...
    private MappingConcrete(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    public int GetMappingPointCount() {
        var _ret_var = CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_point_count_get_ptr.Value.Delegate(this.NativeHandle);
    ...
    public void SetMappingPointCount(int count) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_point_count_set_ptr.Value.Delegate(this.NativeHandle, count);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public bool GetMappingClockwise() {
        var _ret_var = CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_clockwise_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public bool GetMappingSmooth() {
        var _ret_var = CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_smooth_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetMappingSmooth(bool smooth) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_smooth_set_ptr.Value.Delegate(this.NativeHandle, smooth);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public bool GetMappingAlpha() {
        var _ret_var = CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_alpha_get_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void SetMappingAlpha(bool alpha) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_alpha_set_ptr.Value.Delegate(this.NativeHandle, alpha);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void GetMappingCoordAbsolute(int idx, out double x, out double y, out double z) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_coord_absolute_get_ptr.Value.Delegate(this.NativeHandle, idx, out x, out y, out z);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void SetMappingCoordAbsolute(int idx, double x, double y, double z) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_coord_absolute_set_ptr.Value.Delegate(this.NativeHandle, idx, x, y, z);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void GetMappingUv(int idx, out double u, out double v) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_uv_get_ptr.Value.Delegate(this.NativeHandle, idx, out u, out v);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void SetMappingUv(int idx, double u, double v) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_uv_set_ptr.Value.Delegate(this.NativeHandle, idx, u, v);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void GetMappingColor(int idx, out int r, out int g, out int b, out int a) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_color_get_ptr.Value.Delegate(this.NativeHandle, idx, out r, out g, out b, out a);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void SetMappingColor(int idx, int r, int g, int b, int a) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_color_set_ptr.Value.Delegate(this.NativeHandle, idx, r, g, b, a);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public bool HasMapping() {
        var _ret_var = CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_has_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public void ResetMapping() {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_reset_ptr.Value.Delegate(this.NativeHandle);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void Translate(double dx, double dy, double dz) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_translate_ptr.Value.Delegate(this.NativeHandle, dx, dy, dz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <param name="cx">X relative coordinate of the center point.</param>
    /// <param name="cy">y relative coordinate of the center point.</param>
    public void Rotate(double degrees, CoreUI.Gfx.IEntity pivot, double cx, double cy) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_ptr.Value.Delegate(this.NativeHandle, degrees, pivot, cx, cy);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <param name="cy">y relative coordinate of the center point.</param>
    /// <param name="cz">Z absolute coordinate of the center point.</param>
    public void Rotate3d(double dx, double dy, double dz, CoreUI.Gfx.IEntity pivot, double cx, double cy, double cz) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_3d_ptr.Value.Delegate(this.NativeHandle, dx, dy, dz, pivot, cx, cy, cz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <param name="cy">y relative coordinate of the center point.</param>
    /// <param name="cz">Z absolute coordinate of the center point.</param>
    public void RotateQuat(double qx, double qy, double qz, double qw, CoreUI.Gfx.IEntity pivot, double cx, double cy, double cz) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_quat_ptr.Value.Delegate(this.NativeHandle, qx, qy, qz, qw, pivot, cx, cy, cz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <param name="cx">X relative coordinate of the center point.</param>
    /// <param name="cy">y relative coordinate of the center point.</param>
    public void Zoom(double zoomx, double zoomy, CoreUI.Gfx.IEntity pivot, double cx, double cy) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_zoom_ptr.Value.Delegate(this.NativeHandle, zoomx, zoomy, pivot, cx, cy);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <param name="ag">Ambient color green value (0 - 255).</param>
    /// <param name="ab">Ambient color blue value (0 - 255).</param>
    public void Lighting3d(CoreUI.Gfx.IEntity pivot, double lx, double ly, double lz, int lr, int lg, int lb, int ar, int ag, int ab) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_lighting_3d_ptr.Value.Delegate(this.NativeHandle, pivot, lx, ly, lz, lr, lg, lb, ar, ag, ab);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// <param name="z0">The &quot;0&quot; Z plane value.</param>
    /// <param name="foc">The focal distance, must be greater than 0.</param>
    public void Perspective3d(CoreUI.Gfx.IEntity pivot, double px, double py, double z0, double foc) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_perspective_3d_ptr.Value.Delegate(this.NativeHandle, pivot, px, py, z0, foc);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void RotateAbsolute(double degrees, double cx, double cy) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_absolute_ptr.Value.Delegate(this.NativeHandle, degrees, cx, cy);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void Rotate3dAbsolute(double dx, double dy, double dz, double cx, double cy, double cz) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_3d_absolute_ptr.Value.Delegate(this.NativeHandle, dx, dy, dz, cx, cy, cz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void RotateQuatAbsolute(double qx, double qy, double qz, double qw, double cx, double cy, double cz) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_rotate_quat_absolute_ptr.Value.Delegate(this.NativeHandle, qx, qy, qz, qw, cx, cy, cz);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void ZoomAbsolute(double zoomx, double zoomy, double cx, double cy) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_zoom_absolute_ptr.Value.Delegate(this.NativeHandle, zoomx, zoomy, cx, cy);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void Lighting3dAbsolute(double lx, double ly, double lz, int lr, int lg, int lb, int ar, int ag, int ab) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_lighting_3d_absolute_ptr.Value.Delegate(this.NativeHandle, lx, ly, lz, lr, lg, lb, ar, ag, ab);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public void Perspective3dAbsolute(double px, double py, double z0, double foc) {
        CoreUI.Gfx.MappingConcrete.NativeMethods.efl_gfx_mapping_perspective_3d_absolute_ptr.Value.Delegate(this.NativeHandle, px, py, z0, foc);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
#pragma warning restore CS0628
    ...
    {
        return CoreUI.Gfx.MappingConcrete.efl_gfx_mapping_mixin_get();
    }
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class MappingConcreteExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<int> MappingPointCount<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Gfx.IMapping, T>magic = null) where T : CoreUI.Gfx.IMapping {
        return new CoreUI.BindableProperty<int>("mapping_point_count", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> MappingSmooth<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Gfx.IMapping, T>magic = null) where T : CoreUI.Gfx.IMapping {
        return new CoreUI.BindableProperty<bool>("mapping_smooth", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> MappingAlpha<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Gfx.IMapping, T>magic = null) where T : CoreUI.Gfx.IMapping {
