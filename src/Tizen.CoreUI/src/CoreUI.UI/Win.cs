...
namespace CoreUI.UI {
/// <summary>Event argument wrapper for event <see cref="CoreUI.UI.Win.FullscreenChangedEvent"/>.
/// </summary>
...
/// <summary>Event argument wrapper for event <see cref="CoreUI.UI.Win.MaximizedChangedEvent"/>.
/// </summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.Wrapper.BindingEntity]
...
/// <summary>Event argument wrapper for event <see cref="CoreUI.UI.Win.WinRotationChangedEvent"/>.
/// </summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.Wrapper.BindingEntity]
...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    ...
    /// <summary>Method to raise event DeleteRequestEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnDeleteRequestEvent()
    {
    ...
    /// <summary>Method to raise event MinimizedEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnMinimizedEvent()
    {
        CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_UI_WIN_EVENT_MINIMIZED", IntPtr.Zero, null);
    }
    ...
    /// <summary>Method to raise event NormalEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnNormalEvent()
    {
        CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_UI_WIN_EVENT_NORMAL", IntPtr.Zero, null);
    }
    ...
    public event EventHandler<CoreUI.UI.WinFullscreenChangedEventArgs> FullscreenChangedEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event FullscreenChangedEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnFullscreenChangedEvent(CoreUI.UI.WinFullscreenChangedEventArgs e)
    {
    ...
    public event EventHandler<CoreUI.UI.WinMaximizedChangedEventArgs> MaximizedChangedEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event MaximizedChangedEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnMaximizedChangedEvent(CoreUI.UI.WinMaximizedChangedEventArgs e)
    {
        IntPtr info = CoreUI.DataTypes.PrimitiveConversion.ManagedToPointerAlloc(e.arg ? (byte) 1 : (byte) 0);
    ...
    public event EventHandler<CoreUI.UI.WinWinRotationChangedEventArgs> WinRotationChangedEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event WinRotationChangedEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnWinRotationChangedEvent(CoreUI.UI.WinWinRotationChangedEventArgs e)
    {
    ...
    /// <summary>Method to raise event ThemeChangedEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnThemeChangedEvent()
    {
    ...
    /// <summary>Method to raise event PauseEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    ...
    /// <summary>Method to raise event ResumeEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnResumeEvent()
    {
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnContentChangedEvent(CoreUI.ContentContentChangedEventArgs e)
    {
...
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_CONTENT_EVENT_CONTENT_CHANGED", info, null);
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnSceneFocusInEvent()
    {
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnSceneFocusOutEvent()
    {
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnObjectFocusInEvent(CoreUI.Canvas.SceneObjectFocusInEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_CANVAS_SCENE_EVENT_OBJECT_FOCUS_IN", info, null);
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnObjectFocusOutEvent(CoreUI.Canvas.SceneObjectFocusOutEventArgs e)
    {
        IntPtr info = e.arg.NativeHandle;
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_CANVAS_SCENE_EVENT_OBJECT_FOCUS_OUT", info, null);
    ...
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnRenderPreEvent()
    {
...
CoreUI.UI.Win.NativeMethods.efl_ui_win_hint_step_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_sz);
    ...
    public virtual CoreUI.Gfx.IEntity GetContent() {
        var _ret_var = CoreUI.ContentConcrete.NativeMethods.efl_content_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual bool SetContent(CoreUI.Gfx.IEntity content) {
        var _ret_var = CoreUI.ContentConcrete.NativeMethods.efl_content_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), content);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.Gfx.IEntity UnsetContent() {
        var _ret_var = CoreUI.ContentConcrete.NativeMethods.efl_content_unset_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Size2D GetScreenSizeInPixels() {
        var _ret_var = CoreUI.ScreenConcrete.NativeMethods.efl_screen_size_in_pixels_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual float GetScreenScaleFactor() {
        var _ret_var = CoreUI.ScreenConcrete.NativeMethods.efl_screen_scale_factor_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual int GetScreenRotation() {
        var _ret_var = CoreUI.ScreenConcrete.NativeMethods.efl_screen_rotation_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void GetScreenDpi(out int xdpi, out int ydpi) {
        CoreUI.ScreenConcrete.NativeMethods.efl_screen_dpi_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out xdpi, out ydpi);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
var _ret_var = CoreUI.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_image_max_size_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), out _out_max);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
max = _out_max;
        return _ret_var;
    }
    ...
    public virtual bool GetGroupObjectsCalculating() {
        var _ret_var = CoreUI.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_group_objects_calculating_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void CalculateGroupObjects() {
        CoreUI.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_group_objects_calculate_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
...
var _ret_var = CoreUI.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_objects_at_xy_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_pos, include_pass_events_objects, include_hidden_objects);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    public virtual CoreUI.Gfx.IEntity GetObjectTopAtXy(CoreUI.DataTypes.Position2D pos, bool include_pass_events_objects, bool include_hidden_objects) {
        CoreUI.DataTypes.Position2D.NativeStruct _in_pos = pos;
var _ret_var = CoreUI.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_object_top_at_xy_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_pos, include_pass_events_objects, include_hidden_objects);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
...
var _ret_var = CoreUI.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_objects_in_rectangle_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_rect, include_pass_events_objects, include_hidden_objects);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return CoreUI.Wrapper.Globals.IteratorToIEnumerable<CoreUI.Gfx.IEntity>(_ret_var);
    }
    ...
    public virtual CoreUI.Gfx.IEntity GetObjectTopInRectangle(CoreUI.DataTypes.Rect rect, bool include_pass_events_objects, bool include_hidden_objects) {
        CoreUI.DataTypes.Rect.NativeStruct _in_rect = rect;
var _ret_var = CoreUI.Canvas.SceneConcrete.NativeMethods.efl_canvas_scene_object_top_in_rectangle_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), _in_rect, include_pass_events_objects, include_hidden_objects);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    /// </summary>
        ...
        private delegate CoreUI.DataTypes.Size2D.NativeStruct efl_ui_win_hint_base_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Size2D.NativeStruct efl_ui_win_hint_base_get_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Size2D.NativeStruct hint_base_get(System.IntPtr obj, System.IntPtr pd)
        {
        ...
        private delegate void efl_ui_win_hint_base_set_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Size2D.NativeStruct sz);

        
        internal delegate void efl_ui_win_hint_base_set_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Size2D.NativeStruct sz);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static void hint_base_set(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Size2D.NativeStruct sz)
        {
        ...
        private delegate CoreUI.DataTypes.Size2D.NativeStruct efl_ui_win_hint_step_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Size2D.NativeStruct efl_ui_win_hint_step_get_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Size2D.NativeStruct hint_step_get(System.IntPtr obj, System.IntPtr pd)
        {
        ...
        private delegate void efl_ui_win_hint_step_set_delegate(System.IntPtr obj, System.IntPtr pd,  CoreUI.DataTypes.Size2D.NativeStruct sz);

        
        internal delegate void efl_ui_win_hint_step_set_api_delegate(System.IntPtr obj,  CoreUI.DataTypes.Size2D.NativeStruct sz);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static void hint_step_set(System.IntPtr obj, System.IntPtr pd, CoreUI.DataTypes.Size2D.NativeStruct sz)
        {
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class WinExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.WinIndicatorMode> IndicatorMode<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<CoreUI.UI.WinIndicatorMode>("indicator_mode", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Value> ExitOnClose<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Value>("exit_on_close", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Canvas.Object> IconObject<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<CoreUI.Canvas.Object>("icon_object", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Minimized<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<bool>("minimized", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Maximized<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<bool>("maximized", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Fullscreen<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<bool>("fullscreen", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> WinName<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<System.String>("win_name", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Alpha<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<bool>("alpha", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Value> ExitOnAllWindowsClosed<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Value>("exit_on_all_windows_closed", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Size2D> HintBase<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Size2D>("hint_base", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.DataTypes.Size2D> HintStep<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<CoreUI.DataTypes.Size2D>("hint_step", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> FocusHighlightEnabled<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<bool>("focus_highlight_enabled", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> FocusHighlightStyle<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<System.String>("focus_highlight_style", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> FocusHighlightAnimate<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<bool>("focus_highlight_animate", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
        return new CoreUI.BindableProperty<CoreUI.Gfx.IEntity>("content", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Text<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Win, T>magic = null) where T : CoreUI.UI.Win {
