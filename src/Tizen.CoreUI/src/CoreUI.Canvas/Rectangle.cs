...
[CoreUI.Canvas.Rectangle.NativeMethods]
[CoreUI.Wrapper.BindingEntity]
[SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
public class Rectangle : CoreUI.Canvas.Object
{
    ...
    /// <since_tizen> 6 </since_tizen>
    public Rectangle(CoreUI.Object parent= null) : base(efl_canvas_rectangle_class_get(), parent)
    {
        FinishInstantiation();
    }
    ...
    internal Rectangle(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
    ...
    protected Rectangle(IntPtr baseKlass, CoreUI.Object parent) : base(baseKlass, parent)
    {
    }
    ...
    {
        return CoreUI.Canvas.Rectangle.efl_canvas_rectangle_class_get();
    }
