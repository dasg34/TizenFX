...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    ...
    /// <summary>Method to raise event FocusedEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnFocusedEvent()
    {
    ...
    /// <summary>Method to raise event UnfocusedEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnUnfocusedEvent()
    {
    ...
    /// <summary>Method to raise event AtspiHighlightedEvent.
    /// </summary>
    protected virtual void OnAtspiHighlightedEvent()
    {
    ...
    /// <summary>Method to raise event AtspiUnhighlightedEvent.
    /// </summary>
    protected virtual void OnAtspiUnhighlightedEvent()
    {
    ...
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPropertiesChangedEvent(CoreUI.UI.PropertyBindPropertiesChangedEventArgs e)
    {
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnPropertyBoundEvent(CoreUI.UI.PropertyBindPropertyBoundEventArgs e)
    {
    ...
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnModelChangedEvent(CoreUI.UI.ViewModelChangedEventArgs e)
    {
        IntPtr info = Marshal.AllocHGlobal(Marshal.SizeOf(e.arg));
    ...
    public virtual CoreUI.Object GetPart(System.String name) {
        var _ret_var = CoreUI.PartConcrete.NativeMethods.efl_part_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), name);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.DataTypes.Error BindProperty(System.String key, System.String property) {
        var _ret_var = CoreUI.UI.PropertyBindConcrete.NativeMethods.efl_ui_property_bind_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), key, property);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual CoreUI.IModel GetModel() {
        var _ret_var = CoreUI.UI.ViewConcrete.NativeMethods.efl_ui_view_model_get_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)));
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
        return _ret_var;
    }
    ...
    public virtual void SetModel(CoreUI.IModel model) {
        CoreUI.UI.ViewConcrete.NativeMethods.efl_ui_view_model_set_ptr.Value.Delegate((IsGeneratedBindingClass ? this.NativeHandle : CoreUI.Wrapper.Globals.Super(this.NativeHandle, this.NativeClass)), model);
        CoreUI.DataTypes.Error.RaiseIfUnhandledException();
    ...
    /// 
    /// This property is protected as it is meant for widget implementations only, to set and access the internal canvas object. Do use this function unless you&apos;re implementing a widget.</summary>
    /// <value>A canvas object (often a <span class="text-muted">CoreUI.Canvas.Layout (object still in beta stage)</span> object).</value>
    /// <since_tizen> 6 </since_tizen>
    protected CoreUI.Canvas.Object ResizeObject {
    ...
    /// </summary>
        ...
        private delegate CoreUI.DataTypes.Rect.NativeStruct efl_ui_widget_interest_region_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Rect.NativeStruct efl_ui_widget_interest_region_get_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Rect.NativeStruct interest_region_get(System.IntPtr obj, System.IntPtr pd)
        {
        ...
        private delegate CoreUI.DataTypes.Rect.NativeStruct efl_ui_widget_focus_highlight_geometry_get_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate CoreUI.DataTypes.Rect.NativeStruct efl_ui_widget_focus_highlight_geometry_get_api_delegate(System.IntPtr obj);
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static CoreUI.DataTypes.Rect.NativeStruct focus_highlight_geometry_get(System.IntPtr obj, System.IntPtr pd)
        {
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class WidgetExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Canvas.Object> ResizeObject<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Widget, T>magic = null) where T : CoreUI.UI.Widget {
        return new CoreUI.BindableProperty<CoreUI.Canvas.Object>("resize_object", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> Disabled<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Widget, T>magic = null) where T : CoreUI.UI.Widget {
        return new CoreUI.BindableProperty<bool>("disabled", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Style<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Widget, T>magic = null) where T : CoreUI.UI.Widget {
        return new CoreUI.BindableProperty<System.String>("style", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> FocusAllow<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Widget, T>magic = null) where T : CoreUI.UI.Widget {
        return new CoreUI.BindableProperty<bool>("focus_allow", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.Widget> WidgetParent<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Widget, T>magic = null) where T : CoreUI.UI.Widget {
        return new CoreUI.BindableProperty<CoreUI.UI.Widget>("widget_parent", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<bool> WidgetFocus<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Widget, T>magic = null) where T : CoreUI.UI.Widget {
        return new CoreUI.BindableProperty<bool>("widget_focus", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.Focus.MovePolicy> FocusMovePolicy<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Widget, T>magic = null) where T : CoreUI.UI.Widget {
        return new CoreUI.BindableProperty<CoreUI.UI.Focus.MovePolicy>("focus_move_policy", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.IModel> Model<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Widget, T>magic = null) where T : CoreUI.UI.Widget {
        return new CoreUI.BindableProperty<CoreUI.IModel>("model", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindablePart<CoreUI.UI.WidgetPartBg> BackgroundPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Widget, T> x=null) where T : CoreUI.UI.Widget
    {
        return new CoreUI.BindablePart<CoreUI.UI.WidgetPartBg>("background", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindablePart<CoreUI.UI.WidgetPartShadow> ShadowPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.Widget, T> x=null) where T : CoreUI.UI.Widget
    {
        return new CoreUI.BindablePart<CoreUI.UI.WidgetPartShadow>("shadow", fac);
    }
