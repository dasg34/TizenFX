...
namespace CoreUI.UI {
/// <summary>Event argument wrapper for event <see cref="CoreUI.UI.AlertPopup.ButtonClickedEvent"/>.
/// </summary>
...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    ...
    public event EventHandler<CoreUI.UI.AlertPopupButtonClickedEventArgs> ButtonClickedEvent
    {
        add
        {
    ...
    /// <summary>Method to raise event ButtonClickedEvent.
    /// </summary>
    /// <param name="e">Event to raise.</param>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnButtonClickedEvent(CoreUI.UI.AlertPopupButtonClickedEventArgs e)
    {
    ...
    /// <since_tizen> 6 </since_tizen>
    public (CoreUI.UI.AlertPopupButton, System.String, CoreUI.Canvas.Object) Button {
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class AlertPopupExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindablePart<CoreUI.UI.AlertPopupPartTitle> TitlePart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.AlertPopup, T> x=null) where T : CoreUI.UI.AlertPopup
    {
        return new CoreUI.BindablePart<CoreUI.UI.AlertPopupPartTitle>("title", fac);
    }
...
namespace CoreUI.UI {
/// <summary>Information for <see cref="CoreUI.UI.AlertPopup.ButtonClickedEvent"/> event.</summary>
/// <since_tizen> 6 </since_tizen>
...
public struct AlertPopupButtonClickedEvent : IEquatable<AlertPopupButtonClickedEvent>
{
    ...
    public CoreUI.UI.AlertPopupButton Button_type;
    ...
    public AlertPopupButtonClickedEvent(
        CoreUI.UI.AlertPopupButton Button_type = default(CoreUI.UI.AlertPopupButton)    )
    {
    ...
    public void Deconstruct(
        out CoreUI.UI.AlertPopupButton Button_type
    )
    {
    ...
    {
        int hash = 17;
        hash = hash * 23 + Button_type.GetHashCode();
        return hash;
    }
    ...
    {
        return Button_type == other.Button_type        ;
    }
    /// <summary>Equality comparison.
    /// </summary>
