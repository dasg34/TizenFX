...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class RadioGroupImplExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<int> SelectedValue<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.RadioGroupImpl, T>magic = null) where T : CoreUI.UI.RadioGroupImpl {
        return new CoreUI.BindableProperty<int>("selected_value", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.ISelectable> FallbackSelection<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.RadioGroupImpl, T>magic = null) where T : CoreUI.UI.RadioGroupImpl {
