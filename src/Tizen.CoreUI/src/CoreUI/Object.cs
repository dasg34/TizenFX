...
public abstract partial class Object : CoreUI.Wrapper.ObjectWrapper
{
    ...
    /// <summary>Object is being deleted. See <see cref="CoreUI.Object.Destructor"/>.</summary>
    /// <since_tizen> 6 </since_tizen>
    ...
    /// <summary>Method to raise event DelEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnDelEvent()
    {
        CallNativeEventCallback(CoreUI.Libs.Eo, "_EFL_EVENT_DEL", IntPtr.Zero, null);
    }

    /// <summary>Object is being invalidated and losing its parent. See <see cref="CoreUI.Object.Invalidate"/>.</summary>
    /// <since_tizen> 6 </since_tizen>
    ...
    /// <summary>Method to raise event InvalidateEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnInvalidateEvent()
    {
        CallNativeEventCallback(CoreUI.Libs.Eo, "_EFL_EVENT_INVALIDATE", IntPtr.Zero, null);
    }
    ...
    /// <summary>Method to raise event NorefEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnNorefEvent()
    {
    ...
    /// <summary>Method to raise event OwnershipUniqueEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnOwnershipUniqueEvent()
    {
    ...
    /// <summary>Method to raise event OwnershipSharedEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
    protected virtual void OnOwnershipSharedEvent()
    {
    ...
    /// <summary>Method to raise event DestructEvent.
    /// </summary>
    /// <since_tizen> 6 </since_tizen>
...
public static class ObjectExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Object> Parent<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Object, T>magic = null) where T : CoreUI.Object {
        return new CoreUI.BindableProperty<CoreUI.Object>("parent", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Name<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Object, T>magic = null) where T : CoreUI.Object {
        return new CoreUI.BindableProperty<System.String>("name", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Comment<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Object, T>magic = null) where T : CoreUI.Object {
        return new CoreUI.BindableProperty<System.String>("comment", fac);
    }
