...
namespace CoreUI.UI {
/// <summary>Default Item class to be used inside <see cref="CoreUI.UI.List"/> containers. It displays the three parts in horizontal order: <c>icon</c>, <c>text</c> and <c>extra</c>. Theming can change this arrangement.</summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.UI.ListDefaultItem.NativeMethods]
[CoreUI.Wrapper.BindingEntity]
[SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
public class ListDefaultItem : CoreUI.UI.DefaultItem
{
...
/// <param name="style">The widget style to use. See <see cref="CoreUI.UI.Widget.SetStyle" /></param>
    public ListDefaultItem(CoreUI.Object parent, System.String style = null) : base(efl_ui_list_default_item_class_get(), parent)
    {
    ...
    {
        return CoreUI.UI.ListDefaultItem.efl_ui_list_default_item_class_get();
    }
