...
[CoreUI.UI.LayoutPartContent.NativeMethods]
[CoreUI.Wrapper.BindingEntity]
[SuppressMessage("Microsoft.Naming", "CA1724:TypeNamesShouldNotMatchNamespaces")]
public class LayoutPartContent : CoreUI.UI.LayoutPart, CoreUI.IContent
{
    ...
    /// <since_tizen> 6 </since_tizen>
    public LayoutPartContent(CoreUI.Object parent= null) : base(efl_ui_layout_part_content_class_get(), parent)
    {
        FinishInstantiation();
    }
    ...
    internal LayoutPartContent(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
    ...
    protected LayoutPartContent(IntPtr baseKlass, CoreUI.Object parent) : base(baseKlass, parent)
    {
    }
...
CallNativeEventCallback(CoreUI.Libs.Elementary, "_EFL_CONTENT_EVENT_CONTENT_CHANGED", info, null);
    ...
    {
        return CoreUI.UI.LayoutPartContent.efl_ui_layout_part_content_class_get();
    }
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class LayoutPartContentExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.LayoutPartContent, T>magic = null) where T : CoreUI.UI.LayoutPartContent {
