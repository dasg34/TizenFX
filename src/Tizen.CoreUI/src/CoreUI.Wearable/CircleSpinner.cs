...
namespace CoreUI
{
    namespace Wearable
    {
        ...
        public class CircleSpinner : CoreUI.UI.Spin, CoreUI.UI.IRangeInteractive, ICircleWidget
        {
            ...
            /// Use this event instead of <see cref="CoreUI.UI.IRangeDisplay.ChangedEvent"/>
            ...
            public CircleSpinner(CoreUI.Object parent) : base(parent)
            {
                ...
                this.ChangedEvent += (object sender, EventArgs e) => {
                    CoreUI.LoopTimer timer = new CoreUI.LoopTimer(this, 0.2);
                    timer.TimerTickEvent +=(object timer_sender, EventArgs timer_e) =>
                    {
                        SteadyEvent?.Invoke(this, EventArgs.Empty);
                        timer.Del();
                    };
                };
            }
