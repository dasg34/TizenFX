...
/// 
/// The implementor of this interface provides the possibility to select multiple Selectables. If not, only <see cref="CoreUI.UI.ISingleSelectable"/> should be implemented. A widget can only provide either this interface or <see cref="CoreUI.UI.IMultiSelectableIndexRange"/>, but not both.</summary>
/// <since_tizen> 6 </since_tizen>
[CoreUI.UI.MultiSelectableObjectRangeConcrete.NativeMethods]
[CoreUI.Wrapper.BindingEntity]
public interface IMultiSelectableObjectRange : 
    ...
    CoreUI.Wrapper.IWrapper, IDisposable
{
    ...
    IEnumerable<CoreUI.UI.ISelectable> NewSelectedIterator();
...
/// The implementor of this interface provides the possibility to select multiple Selectables. If not, only <see cref="CoreUI.UI.ISingleSelectable"/> should be implemented. A widget can only provide either this interface or <see cref="CoreUI.UI.IMultiSelectableIndexRange"/>, but not both.</summary>
/// <since_tizen> 6 </since_tizen>
public sealed class MultiSelectableObjectRangeConcrete :
    CoreUI.Wrapper.ObjectWrapper,
    IMultiSelectableObjectRange,
    CoreUI.UI.IMultiSelectable,
    CoreUI.UI.ISingleSelectable
{
    ...
    public override System.IntPtr NativeClass
    {
        get
        {
            if (((object)this).GetType() == typeof(MultiSelectableObjectRangeConcrete))
            {
    ...
    private MultiSelectableObjectRangeConcrete(ConstructingHandle ch) : base(ch)
    {
    }

    [System.Runtime.InteropServices.DllImport(CoreUI.Libs.Elementary)] internal static extern System.IntPtr
        efl_ui_multi_selectable_object_range_interface_get();

    /// <summary>Initializes a new instance of the <see cref="IMultiSelectableObjectRange"/> class.
    /// Internal usage: This is used when interacting with C code and should not be used directly.</summary>
    /// <param name="wh">The native pointer to be wrapped.</param>
    private MultiSelectableObjectRangeConcrete(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning disable CS0628
    ...
    /// <since_tizen> 6 </since_tizen>
    /// <returns>User has to free the iterator after usage.</returns>
    public IEnumerable<CoreUI.UI.ISelectable> NewSelectedIterator() {
        var _ret_var = CoreUI.UI.MultiSelectableObjectRangeConcrete.NativeMethods.efl_ui_multi_selectable_selected_iterator_new_ptr.Value.Delegate(this.NativeHandle);
...
#pragma warning restore CS0628
    ...
    {
        return CoreUI.UI.MultiSelectableObjectRangeConcrete.efl_ui_multi_selectable_object_range_interface_get();
    }
    ...
    /// </summary>
        ...
        internal override System.Collections.Generic.List<CoreUIOpDescription> GetEoOps(System.Type type, bool includeInherited)
        {
            ...
            if (efl_ui_multi_selectable_selected_iterator_new_static_delegate == null)
            {
                efl_ui_multi_selectable_selected_iterator_new_static_delegate = new efl_ui_multi_selectable_selected_iterator_new_delegate(selected_iterator_new);
            }

            if (methods.Contains("NewSelectedIterator"))
            {
                descs.Add(new CoreUIOpDescription() {api_func = CoreUI.Wrapper.FunctionInterop.LoadFunctionPointer(Module.Module, "efl_ui_multi_selectable_selected_iterator_new"), func = Marshal.GetFunctionPointerForDelegate(efl_ui_multi_selectable_selected_iterator_new_static_delegate) });
            }
        ...
        private delegate System.IntPtr efl_ui_multi_selectable_selected_iterator_new_delegate(System.IntPtr obj, System.IntPtr pd);

        
        internal delegate System.IntPtr efl_ui_multi_selectable_selected_iterator_new_api_delegate(System.IntPtr obj);

        internal static readonly CoreUI.Wrapper.FunctionWrapper<efl_ui_multi_selectable_selected_iterator_new_api_delegate> efl_ui_multi_selectable_selected_iterator_new_ptr = new CoreUI.Wrapper.FunctionWrapper<efl_ui_multi_selectable_selected_iterator_new_api_delegate>(Module, "efl_ui_multi_selectable_selected_iterator_new");

        [SuppressMessage("Microsoft.Reliability", "CA2000:DisposeObjectsBeforeLosingScope", Justification = "The instantiated objects can be stored in the called Managed API method.")]
        private static System.IntPtr selected_iterator_new(System.IntPtr obj, System.IntPtr pd)
        {
            CoreUI.DataTypes.Log.Debug("function efl_ui_multi_selectable_selected_iterator_new was called");
            var ws = CoreUI.Wrapper.Globals.GetWrapperSupervisor(obj);
            if (ws != null)
            {
                IEnumerable<CoreUI.UI.ISelectable> _ret_var = null;
                try
                {
                    _ret_var = ((IMultiSelectableObjectRange)ws.Target).NewSelectedIterator();
                }
                catch (Exception e)
                {
            ...
            {
                return efl_ui_multi_selectable_selected_iterator_new_ptr.Value.Delegate(CoreUI.Wrapper.Globals.Super(obj, CoreUI.Wrapper.Globals.GetClass(obj)));
            }
        }

        private static efl_ui_multi_selectable_selected_iterator_new_delegate efl_ui_multi_selectable_selected_iterator_new_static_delegate;
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class MultiSelectableObjectRangeConcreteExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.SelectMode> SelectMode<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.IMultiSelectableObjectRange, T>magic = null) where T : CoreUI.UI.IMultiSelectableObjectRange {
        return new CoreUI.BindableProperty<CoreUI.UI.SelectMode>("select_mode", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.ISelectable> FallbackSelection<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.IMultiSelectableObjectRange, T>magic = null) where T : CoreUI.UI.IMultiSelectableObjectRange {
