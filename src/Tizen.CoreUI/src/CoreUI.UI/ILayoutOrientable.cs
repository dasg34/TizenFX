...
[CoreUI.UI.LayoutOrientableConcrete.NativeMethods]
    ...
    ILayoutOrientable
{
    ...
    private LayoutOrientableConcrete(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning restore CS0628
    ...
    {
        return CoreUI.UI.LayoutOrientableConcrete.efl_ui_layout_orientable_interface_get();
    }
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class LayoutOrientableConcreteExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.LayoutOrientation> Orientation<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.ILayoutOrientable, T>magic = null) where T : CoreUI.UI.ILayoutOrientable {
