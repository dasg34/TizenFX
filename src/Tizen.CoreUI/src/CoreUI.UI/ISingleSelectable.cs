...
[CoreUI.UI.SingleSelectableConcrete.NativeMethods]
    ...
    ISingleSelectable
{
    ...
    private SingleSelectableConcrete(CoreUI.Wrapper.WrappingHandle wh) : base(wh)
    {
    }
...
#pragma warning restore CS0628
    ...
    {
        return CoreUI.UI.SingleSelectableConcrete.efl_ui_single_selectable_interface_get();
    }
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class SingleSelectableConcreteExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.UI.ISelectable> FallbackSelection<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.ISingleSelectable, T>magic = null) where T : CoreUI.UI.ISingleSelectable {
