...
public class LayoutPartText : CoreUI.UI.LayoutPart, CoreUI.IText
{
...
#pragma warning disable CS1591
/// <since_tizen> 6 </since_tizen>
public static class LayoutPartTextExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Text<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.LayoutPartText, T>magic = null) where T : CoreUI.UI.LayoutPartText {
