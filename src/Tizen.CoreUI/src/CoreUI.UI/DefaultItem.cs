...
public abstract class DefaultItem : CoreUI.UI.Item, CoreUI.IContent, CoreUI.IText
{
...
public static class DefaultItemExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Gfx.IEntity> Content<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.DefaultItem, T>magic = null) where T : CoreUI.UI.DefaultItem {
        return new CoreUI.BindableProperty<CoreUI.Gfx.IEntity>("content", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<System.String> Text<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.DefaultItem, T>magic = null) where T : CoreUI.UI.DefaultItem {
        return new CoreUI.BindableProperty<System.String>("text", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent> ExtraPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.DefaultItem, T> x=null) where T : CoreUI.UI.DefaultItem
    {
        return new CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent>("extra", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent> IconPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.DefaultItem, T> x=null) where T : CoreUI.UI.DefaultItem
    {
        return new CoreUI.BindableFactoryPart<CoreUI.UI.LayoutPartContent>("icon", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindablePart<CoreUI.UI.LayoutPartText> TextPart<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.UI.DefaultItem, T> x=null) where T : CoreUI.UI.DefaultItem
    {
