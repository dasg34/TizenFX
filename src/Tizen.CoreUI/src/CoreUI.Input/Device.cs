...
public static class DeviceExtensionMethods {
    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Input.DeviceType> DeviceType<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Device, T>magic = null) where T : CoreUI.Input.Device {
        return new CoreUI.BindableProperty<CoreUI.Input.DeviceType>("device_type", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<CoreUI.Input.Device> Source<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Device, T>magic = null) where T : CoreUI.Input.Device {
        return new CoreUI.BindableProperty<CoreUI.Input.Device>("source", fac);
    }

    /// <since_tizen> 6 </since_tizen>
    public static CoreUI.BindableProperty<uint> SeatId<T>(this CoreUI.UI.ItemFactory<T> fac, CoreUI.Csharp.ExtensionTag<CoreUI.Input.Device, T>magic = null) where T : CoreUI.Input.Device {
        return new CoreUI.BindableProperty<uint>("seat_id", fac);
    }
